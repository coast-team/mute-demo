...
__ace_shadowed__.define('ace/mode/handlebars', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/html', 'ace/mode/handlebars_highlight_rules', 'ace/mode/behaviour/html', 'ace/mode/folding/html'], function(require, exports, module) ***REMOVED***
...
__ace_shadowed__.define('ace/mode/handlebars_highlight_rules', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/html_highlight_rules'], function(require, exports, module) ***REMOVED***


var oop = require("../lib/oop");
var HtmlHighlightRules = require("./html_highlight_rules").HtmlHighlightRules;

function pop2(currentState, stack) ***REMOVED***
    stack.splice(0, 3);
    return stack.shift() || "start";
***REMOVED***
var HandlebarsHighlightRules = function() ***REMOVED***
    HtmlHighlightRules.call(this);
    var hbs = ***REMOVED***
        regex : "(?=***REMOVED******REMOVED***)",
        push : "handlebars"
***REMOVED***
    for (var key in this.$rules) ***REMOVED***
        this.$rules[key].unshift(hbs);
***REMOVED***
    this.$rules.handlebars = [***REMOVED***
        token : "comment.start",
        regex : "***REMOVED******REMOVED***!--",
        push : [***REMOVED***
            token : "comment.end",
...
__ace_shadowed__.define('ace/mode/behaviour/html', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/behaviour/xml'], function(require, exports, module) ***REMOVED***


var oop = require("../../lib/oop");
var XmlBehaviour = require("../behaviour/xml").XmlBehaviour;

var HtmlBehaviour = function () ***REMOVED***
