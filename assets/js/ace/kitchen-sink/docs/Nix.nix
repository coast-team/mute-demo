***REMOVED***
  ...
  helloserver =
    ...
    ***REMOVED*** config, pkgs, ... ***REMOVED***:
    let
      ...
      packages = import ./default.nix ***REMOVED*** pkgs = pkgs; ***REMOVED***;
    ...
    ***REMOVED***
      ...
      systemd.services.helloserver = ***REMOVED***
        description = "Hello world application";
        # Start the service after the network is available
        after = [ "network.target" ];
        # We're going to run it on port 8080 in production
        environment = ***REMOVED*** PORT = "8080"; ***REMOVED***;
        serviceConfig = ***REMOVED***
          # The actual command to run
          ExecStart = "$***REMOVED***nodejs***REMOVED***/bin/node $***REMOVED***app***REMOVED***/server.js";
  ...
  ***REMOVED***;
      ...
      users.extraUsers = ***REMOVED***
        nodejs = ***REMOVED*** ***REMOVED***;
  ***REMOVED***;
***REMOVED***;
***REMOVED***