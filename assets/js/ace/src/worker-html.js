...
define('ace/mode/html_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/lib/lang', 'ace/worker/mirror', 'ace/mode/html/saxparser'], function(require, exports, module) ***REMOVED***
...
***REMOVED***;
    ...
    this.onUpdate = function() ***REMOVED***
        ...
        parser.contentHandler = ***REMOVED***
           ...
           characters: noop
    ***REMOVED***;
        parser.errorHandler = ***REMOVED***
            error: function(message, location, code) ***REMOVED***
                errors.push(***REMOVED***
                    row: location.line,
...
***REMOVED***);
define('ace/mode/html/saxparser', ['require', 'exports', 'module' ], function(require, exports, module) ***REMOVED***
...
function isScopeMarker(node) ***REMOVED***
	if (node.namespaceURI === "http://www.w3.org/1999/xhtml") ***REMOVED***
		return node.localName === "applet"
			...
			|| node.localName === "th";
	***REMOVED***
	if (node.namespaceURI === "http://www.w3.org/1998/Math/MathML") ***REMOVED***
	...
	***REMOVED***
	if (node.namespaceURI === "http://www.w3.org/2000/svg") ***REMOVED***
...
function isListItemScopeMarker(node) ***REMOVED***
...
function isTableScopeMarker(node) ***REMOVED***
...
function isTableBodyScopeMarker(node) ***REMOVED***
...
***REMOVED***
function ElementStack() ***REMOVED***
	this.elements = [];
	this.rootNode = null;
	this.headElement = null;
	this.bodyElement = null;
***REMOVED***
ElementStack.prototype._inScope = function(localName, isMarker) ***REMOVED***
	for (var i = this.elements.length - 1; i >= 0; i--) ***REMOVED***
	...
	***REMOVED***
***REMOVED***;
ElementStack.prototype.push = function(item) ***REMOVED***
	this.elements.push(item);
***REMOVED***;
ElementStack.prototype.pushHtmlElement = function(item) ***REMOVED***
	this.rootNode = item.node;
	this.push(item);
***REMOVED***;
ElementStack.prototype.pushHeadElement = function(item) ***REMOVED***
	this.headElement = item.node;
	this.push(item);
***REMOVED***;
ElementStack.prototype.pushBodyElement = function(item) ***REMOVED***
	this.bodyElement = item.node;
	this.push(item);
***REMOVED***;
ElementStack.prototype.pop = function() ***REMOVED***
	return this.elements.pop();
***REMOVED***;
ElementStack.prototype.remove = function(item) ***REMOVED***
	this.elements.splice(this.elements.indexOf(item), 1);
***REMOVED***;
ElementStack.prototype.popUntilPopped = function(localName) ***REMOVED***
	var element;
	do ***REMOVED***
		element = this.pop();
	***REMOVED*** while (element.localName != localName);
***REMOVED***;

ElementStack.prototype.popUntilTableScopeMarker = function() ***REMOVED***
	while (!isTableScopeMarker(this.top))
		this.pop();
***REMOVED***;

ElementStack.prototype.popUntilTableBodyScopeMarker = function() ***REMOVED***
	while (!isTableBodyScopeMarker(this.top))
		this.pop();
***REMOVED***;

ElementStack.prototype.popUntilTableRowScopeMarker = function() ***REMOVED***
	while (!isTableRowScopeMarker(this.top))
		this.pop();
***REMOVED***;
ElementStack.prototype.item = function(index) ***REMOVED***
	return this.elements[index];
***REMOVED***;
ElementStack.prototype.contains = function(element) ***REMOVED***
	return this.elements.indexOf(element) !== -1;
***REMOVED***;
ElementStack.prototype.inScope = function(localName) ***REMOVED***
	return this._inScope(localName, isScopeMarker);
***REMOVED***;
ElementStack.prototype.inListItemScope = function(localName) ***REMOVED***
	return this._inScope(localName, isListItemScopeMarker);
***REMOVED***;
ElementStack.prototype.inTableScope = function(localName) ***REMOVED***
	return this._inScope(localName, isTableScopeMarker);
***REMOVED***;
ElementStack.prototype.inButtonScope = function(localName) ***REMOVED***
	return this._inScope(localName, isButtonScopeMarker);
***REMOVED***;
ElementStack.prototype.inSelectScope = function(localName) ***REMOVED***
	return this._inScope(localName, isSelectScopeMarker);
***REMOVED***;
ElementStack.prototype.hasNumberedHeaderElementInScope = function() ***REMOVED***
	for (var i = this.elements.length - 1; i >= 0; i--) ***REMOVED***
		var node = this.elements[i];
	...
	***REMOVED***
***REMOVED***;
ElementStack.prototype.furthestBlockForFormattingElement = function(element) ***REMOVED***
...
***REMOVED***;
ElementStack.prototype.findIndex = function(localName) ***REMOVED***
	for (var i = this.elements.length - 1; i >= 0; i--) ***REMOVED***
...
ElementStack.prototype.remove_openElements_until = function(callback) ***REMOVED***
	var finished = false;
	var element;
	while (!finished) ***REMOVED***
...
Object.defineProperty(ElementStack.prototype, 'top', ***REMOVED***
	get: function() ***REMOVED***
		return this.elements[this.elements.length - 1];
	***REMOVED***
***REMOVED***);

Object.defineProperty(ElementStack.prototype, 'length', ***REMOVED***
	get: function() ***REMOVED***
...
var namedEntityPrefixes = ***REMOVED******REMOVED***;
Object.keys(entities).forEach(function (entityKey) ***REMOVED***
	for (var i = 0; i < entityKey.length; i++) ***REMOVED***
		namedEntityPrefixes[entityKey.substring(0, i + 1)] = true;
	***REMOVED***
***REMOVED***);

function isAlphaNumeric(c) ***REMOVED***
...
function isDecimalDigit(c) ***REMOVED***
	return (c >= '0' && c <= '9');
***REMOVED***

var EntityParser = ***REMOVED******REMOVED***;

EntityParser.consumeEntity = function(buffer, tokenizer, additionalAllowedCharacter) ***REMOVED***
	...
	if (ch == '\t' || ch == '\n' || ch == '\v' || ch == ' ' || ch == '<' || ch == '&') ***REMOVED***
		buffer.unget(consumedCharacters);
		return false;
	***REMOVED***
	if (additionalAllowedCharacter === ch) ***REMOVED***
		buffer.unget(consumedCharacters);
		return false;
	***REMOVED***
	if (ch == '#') ***REMOVED***
		ch = buffer.shift(1);
		if (ch === InputStream.EOF) ***REMOVED***
		...
		***REMOVED***
		...
		if (ch == 'x' || ch == 'X') ***REMOVED***
			...
			***REMOVED***
			consumedCharacters += ch;
		***REMOVED***
		if (isDigit(ch)) ***REMOVED***
			var code = '';
			while (ch !== InputStream.EOF && isDigit(ch)) ***REMOVED***
				code += ch;
				ch = buffer.char();
			***REMOVED***
			...
			if (replacement) ***REMOVED***
				...
				code = replacement;
			***REMOVED***
			if (code > 0xFFFF && code <= 0x10FFFF) ***REMOVED***
		        code -= 0x10000;
		...
		***REMOVED***
		...
		return false;
	***REMOVED***
	if ((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z')) ***REMOVED***
		var mostRecentMatch = '';
		while (namedEntityPrefixes[consumedCharacters]) ***REMOVED***
			if (entities[consumedCharacters]) ***REMOVED***
			...
			***REMOVED***
			...
			consumedCharacters += ch;
		***REMOVED***
		if (!mostRecentMatch) ***REMOVED***
			tokenizer._parseError("expected-named-entity");
			buffer.unget(consumedCharacters);
			return false;
		***REMOVED***
		decodedCharacter = entities[mostRecentMatch];
		if (ch === ';' || !additionalAllowedCharacter || !(isAlphaNumeric(ch) || ch === '=')) ***REMOVED***
			if (consumedCharacters.length > mostRecentMatch.length) ***REMOVED***
...
EntityParser.replaceEntityNumbers = function(c) ***REMOVED***
	switch(c) ***REMOVED***
		...
		default:
			if ((c >= 0xD800 && c <= 0xDFFF) || c > 0x10FFFF) ***REMOVED***
				return 0xFFFD;
			***REMOVED*** else if ((c >= 0x0001 && c <= 0x0008) || (c >= 0x000E && c <= 0x001F) ||
...
***REMOVED***,
***REMOVED***"./InputStream":3,"html5-entities":12***REMOVED***],
3:[function(_dereq_,module,exports)***REMOVED***
function InputStream() ***REMOVED***
	this.data = '';
	this.start = 0;
	this.committed = 0;
	this.eof = false;
	this.lastLocation = ***REMOVED***line: 0, column: 0***REMOVED***;
***REMOVED***
	...
	***REMOVED***,
	char: function() ***REMOVED***
		...
		***REMOVED***
		...
		return ch;
	***REMOVED***,
	advance: function(amount) ***REMOVED***
		this.start += amount;
		if(this.start >= this.data.length) ***REMOVED***
			if(!this.eof) throw InputStream.DRAIN;
			return InputStream.EOF;
		***REMOVED*** else ***REMOVED***
			if(this.committed > this.data.length / 2) ***REMOVED***
		...
		***REMOVED***
	***REMOVED***,
	matchWhile: function(re) ***REMOVED***
		...
		***REMOVED***
	***REMOVED***,
	matchUntil: function(re) ***REMOVED***
		var m, s;
		s = this.slice();
		if(s === InputStream.EOF) ***REMOVED***
			return '';
		***REMOVED*** else if(m = new RegExp(re + (this.eof ? "|$" : "")).exec(s)) ***REMOVED***
		...
		***REMOVED***
	***REMOVED***,
	append: function(data) ***REMOVED***
		this.data += data;
	***REMOVED***,
	shift: function(n) ***REMOVED***
...
function StackItem(namespaceURI, localName, attributes, node) ***REMOVED***
	this.localName = localName;
	this.namespaceURI = namespaceURI;
	this.attributes = attributes;
	this.node = node;
***REMOVED***
StackItem.prototype.isSpecial = function() ***REMOVED***
	return this.namespaceURI in SpecialElements &&
		SpecialElements[this.namespaceURI].indexOf(this.localName) > -1;
***REMOVED***;

StackItem.prototype.isFosterParenting = function() ***REMOVED***
	if (this.namespaceURI === "http://www.w3.org/1999/xhtml") ***REMOVED***
...
StackItem.prototype.isNumberedHeader = function() ***REMOVED***
	if (this.namespaceURI === "http://www.w3.org/1999/xhtml") ***REMOVED***
...
StackItem.prototype.isForeign = function() ***REMOVED***
	return this.namespaceURI != "http://www.w3.org/1999/xhtml";
***REMOVED***;

function getAttribute(item, name) ***REMOVED***
	for (var i = 0; i < item.attributes.length; i++) ***REMOVED***
...
StackItem.prototype.isHtmlIntegrationPoint = function() ***REMOVED***
	if (this.namespaceURI === "http://www.w3.org/1998/Math/MathML") ***REMOVED***
	...
	***REMOVED***
	if (this.namespaceURI === "http://www.w3.org/2000/svg") ***REMOVED***
...
StackItem.prototype.isMathMLTextIntegrationPoint = function() ***REMOVED***
	if (this.namespaceURI === "http://www.w3.org/1998/Math/MathML") ***REMOVED***
...
function isAlpha(c) ***REMOVED***
	return (c >= 'A' && c <= 'Z') || (c >= 'a' && c <= 'z');
***REMOVED***
function Tokenizer(tokenHandler) ***REMOVED***
...
Tokenizer.prototype._parseError = function(code, args) ***REMOVED***
	this._tokenHandler.parseError(code, args);
***REMOVED***;

Tokenizer.prototype._emitToken = function(token) ***REMOVED***
	if (token.type === 'StartTag') ***REMOVED***
		for (var i = 1; i < token.data.length; i++) ***REMOVED***
			if (!token.data[i].nodeName)
				token.data.splice(i--, 1);
		***REMOVED***
	***REMOVED*** else if (token.type === 'EndTag') ***REMOVED***
		if (token.selfClosing) ***REMOVED***
			this._parseError('self-closing-flag-on-end-tag');
		***REMOVED***
		if (token.data.length !== 0) ***REMOVED***
			this._parseError('attributes-in-end-tag');
		***REMOVED***
	***REMOVED***
	this._tokenHandler.processToken(token);
	if (token.type === 'StartTag' && token.selfClosing && !this._tokenHandler.isSelfClosingFlagAcknowledged()) ***REMOVED***
		this._parseError('non-void-element-with-trailing-solidus', ***REMOVED***name: token.name***REMOVED***);
	***REMOVED***
***REMOVED***;

Tokenizer.prototype._emitCurrentToken = function() ***REMOVED***
	this._state = Tokenizer.DATA;
	this._emitToken(this._currentToken);
***REMOVED***;

Tokenizer.prototype._currentAttribute = function() ***REMOVED***
	return this._currentToken.data[this._currentToken.data.length - 1];
***REMOVED***;

Tokenizer.prototype.setState = function(state) ***REMOVED***
	this._state = state;
***REMOVED***;

Tokenizer.prototype.tokenize = function(source) ***REMOVED***
	...
	function data_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'EOF', data: null***REMOVED***);
			return false;
		...
		***REMOVED*** else if (data === '\u0000') ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: data***REMOVED***);
			buffer.commit();
		***REMOVED*** else ***REMOVED***
			var chars = buffer.matchUntil("&|<|\u0000");
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: data + chars***REMOVED***);
			buffer.commit();
		***REMOVED***
		return true;
	***REMOVED***

	function character_reference_in_data_state(buffer) ***REMOVED***
		var character = EntityParser.consumeEntity(buffer, tokenizer);
		tokenizer.setState(data_state);
		tokenizer._emitToken(***REMOVED***type: 'Characters', data: character || '&'***REMOVED***);
		return true;
	***REMOVED***

	function rcdata_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'EOF', data: null***REMOVED***);
			return false;
		...
		***REMOVED*** else if (data === "\u0000") ***REMOVED***
			...
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: '\uFFFD'***REMOVED***);
			buffer.commit();
		***REMOVED*** else ***REMOVED***
			var chars = buffer.matchUntil("&|<|\u0000");
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: data + chars***REMOVED***);
	...
	***REMOVED***
	...
	function character_reference_in_rcdata_state(buffer) ***REMOVED***
		var character = EntityParser.consumeEntity(buffer, tokenizer);
	...
	***REMOVED***
	...
	function rawtext_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'EOF', data: null***REMOVED***);
			return false;
	...
	***REMOVED***
	...
	function plaintext_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'EOF', data: null***REMOVED***);
			return false;
	...
	***REMOVED***
	...
	function script_data_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'EOF', data: null***REMOVED***);
			return false;
	...
	***REMOVED***
	...
	function rcdata_less_than_sign_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === "/") ***REMOVED***
			this._temporaryBuffer = '';
	...
	***REMOVED***
	...
	function rcdata_end_tag_open_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (isAlpha(data)) ***REMOVED***
	...
	***REMOVED***
	...
	function rcdata_end_tag_name_state(buffer) ***REMOVED***
		var appropriate = tokenizer._currentToken && (tokenizer._currentToken.name === this._temporaryBuffer.toLowerCase());
		var data = buffer.char();
		if (isWhitespace(data) && appropriate) ***REMOVED***
			tokenizer._currentToken = ***REMOVED***type: 'EndTag', name: this._temporaryBuffer, data: [], selfClosing: false***REMOVED***;
			tokenizer.setState(before_attribute_name_state);
		***REMOVED*** else if (data === '/' && appropriate) ***REMOVED***
			tokenizer._currentToken = ***REMOVED***type: 'EndTag', name: this._temporaryBuffer, data: [], selfClosing: false***REMOVED***;
		...
		***REMOVED*** else if (data === '>' && appropriate) ***REMOVED***
			...
			tokenizer.setState(data_state);
		***REMOVED*** else if (isAlpha(data)) ***REMOVED***
			this._temporaryBuffer += data;
			buffer.commit();
		***REMOVED*** else ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: '</' + this._temporaryBuffer***REMOVED***);
			buffer.unget(data);
			tokenizer.setState(rcdata_state);
		***REMOVED***
		return true;
	***REMOVED***
	...
	function rawtext_less_than_sign_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === "/") ***REMOVED***
			this._temporaryBuffer = '';
	...
	***REMOVED***
	...
	function rawtext_end_tag_open_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (isAlpha(data)) ***REMOVED***
			this._temporaryBuffer += data;
	...
	***REMOVED***
	...
	function rawtext_end_tag_name_state(buffer) ***REMOVED***
		var appropriate = tokenizer._currentToken && (tokenizer._currentToken.name === this._temporaryBuffer.toLowerCase());
		var data = buffer.char();
		if (isWhitespace(data) && appropriate) ***REMOVED***
			tokenizer._currentToken = ***REMOVED***type: 'EndTag', name: this._temporaryBuffer, data: [], selfClosing: false***REMOVED***;
	...
	***REMOVED***
	...
	function script_data_less_than_sign_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === "/") ***REMOVED***
			this._temporaryBuffer = '';
	...
	***REMOVED***
	...
	function script_data_end_tag_open_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (isAlpha(data)) ***REMOVED***
			this._temporaryBuffer += data;
	...
	***REMOVED***
	...
	function script_data_end_tag_name_state(buffer) ***REMOVED***
		var appropriate = tokenizer._currentToken && (tokenizer._currentToken.name === this._temporaryBuffer.toLowerCase());
		var data = buffer.char();
		if (isWhitespace(data) && appropriate) ***REMOVED***
			tokenizer._currentToken = ***REMOVED***type: 'EndTag', name: 'script', data: [], selfClosing: false***REMOVED***;
			tokenizer.setState(before_attribute_name_state);
		***REMOVED*** else if (data === '/' && appropriate) ***REMOVED***
			tokenizer._currentToken = ***REMOVED***type: 'EndTag', name: 'script', data: [], selfClosing: false***REMOVED***;
			tokenizer.setState(self_closing_tag_state);
	...
	***REMOVED***
	...
	function script_data_escape_start_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === '-') ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: '-'***REMOVED***);
	...
	***REMOVED***
	...
	function script_data_escape_start_dash_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === '-') ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: '-'***REMOVED***);
	...
	***REMOVED***
	...
	function script_data_escaped_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			buffer.unget(data);
			tokenizer.setState(data_state);
	...
	***REMOVED***
	...
	function script_data_escaped_dash_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			buffer.unget(data);
			tokenizer.setState(data_state);
	...
	***REMOVED***
	...
	function script_data_escaped_dash_dash_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function script_data_escaped_less_then_sign_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === '/') ***REMOVED***
			this._temporaryBuffer = '';
	...
	***REMOVED***
	...
	function script_data_escaped_end_tag_open_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (isAlpha(data)) ***REMOVED***
			this._temporaryBuffer = data;
	...
	***REMOVED***
	...
	function script_data_escaped_end_tag_name_state(buffer) ***REMOVED***
		var appropriate = tokenizer._currentToken && (tokenizer._currentToken.name === this._temporaryBuffer.toLowerCase());
		var data = buffer.char();
		if (isWhitespace(data) && appropriate) ***REMOVED***
			tokenizer._currentToken = ***REMOVED***type: 'EndTag', name: 'script', data: [], selfClosing: false***REMOVED***;
	...
	***REMOVED***
	...
	function script_data_double_escape_start_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (isWhitespace(data) || data === '/' || data === '>') ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: data***REMOVED***);
	...
	***REMOVED***
	...
	function script_data_double_escaped_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError('eof-in-script');
			buffer.unget(data);
	...
	***REMOVED***
	...
	function script_data_double_escaped_dash_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError('eof-in-script');
			buffer.unget(data);
	...
	***REMOVED***
	...
	function script_data_double_escaped_dash_dash_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError('eof-in-script');
			buffer.unget(data);
	...
	***REMOVED***
	...
	function script_data_double_escaped_less_than_sign_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === '/') ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: '/'***REMOVED***);
			this._temporaryBuffer = '';
	...
	***REMOVED***
	...
	function script_data_double_escape_end_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (isWhitespace(data) || data === '/' || data === '>') ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: data***REMOVED***);
			if (this._temporaryBuffer.toLowerCase() === 'script')
	...
	***REMOVED***
	...
	function tag_open_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			...
			tokenizer.setState(data_state);
		***REMOVED*** else if (isAlpha(data)) ***REMOVED***
			tokenizer._currentToken = ***REMOVED***type: 'StartTag', name: data.toLowerCase(), data: []***REMOVED***;
	...
	***REMOVED***
	...
	function close_tag_open_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			...
			tokenizer.setState(data_state);
		***REMOVED*** else if (isAlpha(data)) ***REMOVED***
			tokenizer._currentToken = ***REMOVED***type: 'EndTag', name: data.toLowerCase(), data: []***REMOVED***;
			tokenizer.setState(tag_name_state);
		***REMOVED*** else if (data === '>') ***REMOVED***
			tokenizer._parseError("expected-closing-tag-but-got-right-bracket");
			tokenizer.setState(data_state);
		***REMOVED*** else ***REMOVED***
			tokenizer._parseError("expected-closing-tag-but-got-char", ***REMOVED***data: data***REMOVED***); // param 1 is datavars:
			buffer.unget(data);
			tokenizer.setState(bogus_comment_state);
		***REMOVED***
		return true;
	***REMOVED***
	...
	function tag_name_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError('eof-in-tag-name');
			buffer.unget(data);
			tokenizer.setState(data_state);
		***REMOVED*** else if (isWhitespace(data)) ***REMOVED***
			tokenizer.setState(before_attribute_name_state);
		***REMOVED*** else if (isAlpha(data)) ***REMOVED***
	...
	***REMOVED***
	...
	function before_attribute_name_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
		...
		***REMOVED*** else if (isWhitespace(data)) ***REMOVED***
			return true;
		***REMOVED*** else if (isAlpha(data)) ***REMOVED***
			tokenizer._currentToken.data.push(***REMOVED***nodeName: data.toLowerCase(), nodeValue: ""***REMOVED***);
			tokenizer.setState(attribute_name_state);
		***REMOVED*** else if (data === '>') ***REMOVED***
			tokenizer._emitCurrentToken();
		***REMOVED*** else if (data === '/') ***REMOVED***
			tokenizer.setState(self_closing_tag_state);
		***REMOVED*** else if (data === "'" || data === '"' || data === '=' || data === '<') ***REMOVED***
			tokenizer._parseError("invalid-character-in-attribute-name");
			tokenizer._currentToken.data.push(***REMOVED***nodeName: data, nodeValue: ""***REMOVED***);
			tokenizer.setState(attribute_name_state);
		***REMOVED*** else if (data === '\u0000') ***REMOVED***
			tokenizer._parseError("invalid-codepoint");
			tokenizer._currentToken.data.push(***REMOVED***nodeName: "\uFFFD", nodeValue: ""***REMOVED***);
		***REMOVED*** else ***REMOVED***
			tokenizer._currentToken.data.push(***REMOVED***nodeName: data, nodeValue: ""***REMOVED***);
			tokenizer.setState(attribute_name_state);
		***REMOVED***
	...
	***REMOVED***
	...
	function attribute_name_state(buffer) ***REMOVED***
		var data = buffer.char();
		...
		***REMOVED*** else if (data === '/') ***REMOVED***
			tokenizer.setState(self_closing_tag_state);
		***REMOVED*** else if (data === "'" || data === '"') ***REMOVED***
			tokenizer._parseError("invalid-character-in-attribute-name");
		...
		***REMOVED***
		...
		if (leavingThisState) ***REMOVED***
			var attributes = tokenizer._currentToken.data;
			var currentAttribute = attributes[attributes.length - 1];
			for (var i = attributes.length - 2; i >= 0; i--) ***REMOVED***
				if (currentAttribute.nodeName === attributes[i].nodeName) ***REMOVED***
					tokenizer._parseError("duplicate-attribute", ***REMOVED***name: currentAttribute.nodeName***REMOVED***);
	...
	***REMOVED***
	...
	function after_attribute_name_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
		...
		***REMOVED*** else if (data === '/') ***REMOVED***
			tokenizer.setState(self_closing_tag_state);
		***REMOVED*** else if (data === "'" || data === '"' || data === '<') ***REMOVED***
	...
	***REMOVED***
	...
	function before_attribute_value_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function attribute_value_double_quoted_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function attribute_value_single_quoted_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function attribute_value_unquoted_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
		...
		***REMOVED*** else if (data === '>') ***REMOVED***
			tokenizer._emitCurrentToken();
		***REMOVED*** else if (data === '"' || data === "'" || data === '=' || data === '`' || data === '<') ***REMOVED***
			tokenizer._parseError("unexpected-character-in-unquoted-attribute-value");
			tokenizer._currentAttribute().nodeValue += data;
			buffer.commit();
		***REMOVED*** else if (data === '\u0000') ***REMOVED***
	...
	***REMOVED***
	...
	function character_reference_in_attribute_value_state(buffer) ***REMOVED***
	...
	***REMOVED***
	...
	function after_attribute_value_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-after-attribute-value");
			buffer.unget(data);
	...
	***REMOVED***
	...
	function self_closing_tag_state(buffer) ***REMOVED***
		var c = buffer.char();
		if (c === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function bogus_comment_state(buffer) ***REMOVED***
		var data = buffer.matchUntil('>');
		data = data.replace(/\u0000/g, "\uFFFD");
		buffer.char();
		tokenizer._emitToken(***REMOVED***type: 'Comment', data: data***REMOVED***);
		tokenizer.setState(data_state);
		return true;
	***REMOVED***

	function markup_declaration_open_state(buffer) ***REMOVED***
		var chars = buffer.shift(2);
		if (chars === '--') ***REMOVED***
			tokenizer._currentToken = ***REMOVED***type: 'Comment', data: ''***REMOVED***;
			tokenizer.setState(comment_start_state);
		***REMOVED*** else ***REMOVED***
			var newchars = buffer.shift(5);
			if (newchars === InputStream.EOF || chars === InputStream.EOF) ***REMOVED***
			...
			***REMOVED***
			...
			chars += newchars;
			if (chars.toUpperCase() === 'DOCTYPE') ***REMOVED***
				tokenizer._currentToken = ***REMOVED***type: 'Doctype', name: '', publicId: null, systemId: null, forceQuirks: false***REMOVED***;
				tokenizer.setState(doctype_state);
			***REMOVED*** else if (tokenizer._tokenHandler.isCdataSectionAllowed() && chars === '[CDATA[') ***REMOVED***
	...
	***REMOVED***
	...
	function cdata_section_state(buffer) ***REMOVED***
		var data = buffer.matchUntil(']]>');
		buffer.shift(3);
		if (data) ***REMOVED***
			tokenizer._emitToken(***REMOVED***type: 'Characters', data: data***REMOVED***);
	...
	***REMOVED***
	...
	function comment_start_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function comment_start_dash_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-comment");
			tokenizer._emitToken(tokenizer._currentToken);
	...
	***REMOVED***
	...
	function comment_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-comment");
			tokenizer._emitToken(tokenizer._currentToken);
	...
	***REMOVED***
	...
	function comment_end_dash_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function comment_end_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function comment_end_bang_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function doctype_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
	...
	***REMOVED***
	...
	function before_doctype_name_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("expected-doctype-name-but-got-eof");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function doctype_name_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._currentToken.forceQuirks = true;
			buffer.unget(data);
	...
	***REMOVED***
	...
	function after_doctype_name_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._currentToken.forceQuirks = true;
			buffer.unget(data);
		...
		***REMOVED*** else if (data === '>') ***REMOVED***
			...
			tokenizer._emitCurrentToken();
		***REMOVED*** else ***REMOVED***
			if (['p', 'P'].indexOf(data) > -1) ***REMOVED***
				var expected = [['u', 'U'], ['b', 'B'], ['l', 'L'], ['i', 'I'], ['c', 'C']];
				var matched = expected.every(function(expected)***REMOVED***
					data = buffer.char();
				...
				***REMOVED***);
				if (matched) ***REMOVED***
					...
					return true;
				***REMOVED***
			***REMOVED*** else if (['s', 'S'].indexOf(data) > -1) ***REMOVED***
			...
			***REMOVED***
			...
			if (data === InputStream.EOF) ***REMOVED***
				...
				tokenizer._emitCurrentToken();
			***REMOVED*** else ***REMOVED***
				tokenizer._parseError("expected-space-or-right-bracket-in-doctype", ***REMOVED***data: data***REMOVED***);
	...
	***REMOVED***
	...
	function after_doctype_public_keyword_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function before_doctype_public_identifier_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function doctype_public_identifier_double_quoted_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function doctype_public_identifier_single_quoted_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function after_doctype_public_identifier_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function between_doctype_public_and_system_identifiers_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function after_doctype_system_keyword_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function before_doctype_system_identifier_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function doctype_system_identifier_double_quoted_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function doctype_system_identifier_single_quoted_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function after_doctype_system_identifier_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			tokenizer._parseError("eof-in-doctype");
			tokenizer._currentToken.forceQuirks = true;
	...
	***REMOVED***
	...
	function bogus_doctype_state(buffer) ***REMOVED***
		var data = buffer.char();
		if (data === InputStream.EOF) ***REMOVED***
			buffer.unget(data);
			tokenizer._emitCurrentToken();
...
Object.defineProperty(Tokenizer.prototype, 'lineNumber', ***REMOVED***
	get: function() ***REMOVED***
		return this._inputStream.location().line;
	***REMOVED***
***REMOVED***);

Object.defineProperty(Tokenizer.prototype, 'columnNumber', ***REMOVED***
	get: function() ***REMOVED***
...
***REMOVED***,
***REMOVED***"./EntityParser":2,"./InputStream":3***REMOVED***],
...
function isWhitespace(ch) ***REMOVED***
	return ch === " " || ch === "\n" || ch === "\t" || ch === "\r" || ch === "\f";
***REMOVED***

function isWhitespaceOrReplacementCharacter(ch) ***REMOVED***
	return isWhitespace(ch) || ch === '\uFFFD';
***REMOVED***

function isAllWhitespace(characters) ***REMOVED***
	for (var i = 0; i < characters.length; i++) ***REMOVED***
		var ch = characters[i];
		if (!isWhitespace(ch))
			return false;
	***REMOVED***
...
function isAllWhitespaceOrReplacementCharacters(characters) ***REMOVED***
	for (var i = 0; i < characters.length; i++) ***REMOVED***
		var ch = characters[i];
...
function getAttribute(node, name) ***REMOVED***
	for (var i = 0; i < node.attributes.length; i++) ***REMOVED***
		var attribute = node.attributes[i];
		if (attribute.nodeName === name) ***REMOVED***
			return attribute;
		***REMOVED***
	***REMOVED***
	return null;
...
function CharacterBuffer(characters) ***REMOVED***
	this.characters = characters;
	this.current = 0;
	this.end = this.characters.length;
***REMOVED***

CharacterBuffer.prototype.skipAtMostOneLeadingNewline = function() ***REMOVED***
	if (this.characters[this.current] === '\n')
		this.current++;
***REMOVED***;

CharacterBuffer.prototype.skipLeadingWhitespace = function() ***REMOVED***
	while (isWhitespace(this.characters[this.current])) ***REMOVED***
		if (++this.current == this.end)
			return;
	***REMOVED***
***REMOVED***;

CharacterBuffer.prototype.skipLeadingNonWhitespace = function() ***REMOVED***
	while (!isWhitespace(this.characters[this.current])) ***REMOVED***
		if (++this.current == this.end)
			return;
	***REMOVED***
...
CharacterBuffer.prototype.takeRemaining = function() ***REMOVED***
	return this.characters.substring(this.current);
***REMOVED***;

CharacterBuffer.prototype.takeLeadingWhitespace = function() ***REMOVED***
...
Object.defineProperty(CharacterBuffer.prototype, 'length', ***REMOVED***
	get: function()***REMOVED***
		return this.end - this.current;
	***REMOVED***
***REMOVED***);
function TreeBuilder() ***REMOVED***
	this.tokenizer = null;
	...
	var tree = this;
	var modes = this.insertionModes = ***REMOVED******REMOVED***;
	modes.base = ***REMOVED***
		end_tag_handlers: ***REMOVED***"-default": 'endTagOther'***REMOVED***,
		start_tag_handlers: ***REMOVED***"-default": 'startTagOther'***REMOVED***,
		processEOF: function() ***REMOVED***
			tree.generateImpliedEndTags();
			if (tree.openElements.length > 2) ***REMOVED***
				tree.parseError('expected-closing-tag-but-got-eof');
			***REMOVED*** else if (tree.openElements.length == 2 &&
				tree.openElements.item(1).localName != 'body') ***REMOVED***
				tree.parseError('expected-closing-tag-but-got-eof');
			***REMOVED*** else if (tree.context && tree.openElements.length > 1) ***REMOVED***
			***REMOVED***
		***REMOVED***,
		processComment: function(data) ***REMOVED***
			tree.insertComment(data, tree.currentStackItem().node);
		***REMOVED***,
		processDoctype: function(name, publicId, systemId, forceQuirks) ***REMOVED***
			tree.parseError('unexpected-doctype');
		***REMOVED***,
		processStartTag: function(name, attributes, selfClosing) ***REMOVED***
			if (this[this.start_tag_handlers[name]]) ***REMOVED***
				this[this.start_tag_handlers[name]](name, attributes, selfClosing);
			***REMOVED*** else if (this[this.start_tag_handlers["-default"]]) ***REMOVED***
				this[this.start_tag_handlers["-default"]](name, attributes, selfClosing);
			***REMOVED*** else ***REMOVED***
				throw(new Error("No handler found for "+name));
			***REMOVED***
		***REMOVED***,
		processEndTag: function(name) ***REMOVED***
			if (this[this.end_tag_handlers[name]]) ***REMOVED***
				this[this.end_tag_handlers[name]](name);
			***REMOVED*** else if (this[this.end_tag_handlers["-default"]]) ***REMOVED***
				this[this.end_tag_handlers["-default"]](name);
			***REMOVED*** else ***REMOVED***
				throw(new Error("No handler found for "+name));
			***REMOVED***
		***REMOVED***,
		startTagHtml: function(name, attributes) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.initial.processEOF = function() ***REMOVED***
		tree.parseError("expected-doctype-but-got-eof");
		this.anythingElse();
		tree.insertionMode.processEOF();
	***REMOVED***;

	modes.initial.processComment = function(data) ***REMOVED***
		tree.insertComment(data, tree.document);
	***REMOVED***;

	modes.initial.processDoctype = function(name, publicId, systemId, forceQuirks) ***REMOVED***
		...
		***REMOVED*** else ***REMOVED***
			...
			***REMOVED*** else if (!((systemId == null || systemId == "about:legacy-compat") && publicId == null)) ***REMOVED***
				tree.parseError("unknown-doctype");
			***REMOVED***
		***REMOVED***
		tree.setInsertionMode('beforeHTML');
		function publicIdStartsWith(string) ***REMOVED***
			return publicId.toLowerCase().indexOf(string) === 0;
		***REMOVED***
	***REMOVED***;

	modes.initial.processCharacters = function(buffer) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.initial.processStartTag = function(name, attributes, selfClosing) ***REMOVED***
		tree.parseError('expected-doctype-but-got-start-tag', ***REMOVED***name: name***REMOVED***);
		this.anythingElse();
		tree.insertionMode.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.initial.processEndTag = function(name) ***REMOVED***
		tree.parseError('expected-doctype-but-got-end-tag', ***REMOVED***name: name***REMOVED***);
		this.anythingElse();
		tree.insertionMode.processEndTag(name);
	***REMOVED***;

	modes.initial.anythingElse = function() ***REMOVED***
		tree.compatMode = 'quirks';
		tree.setInsertionMode('beforeHTML');
	***REMOVED***;
	...
	modes.beforeHTML.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		'-default': 'startTagOther'
	***REMOVED***;

	modes.beforeHTML.processEOF = function() ***REMOVED***
		this.anythingElse();
		tree.insertionMode.processEOF();
	***REMOVED***;

	modes.beforeHTML.processComment = function(data) ***REMOVED***
		tree.insertComment(data, tree.document);
	***REMOVED***;

	modes.beforeHTML.processCharacters = function(buffer) ***REMOVED***
		buffer.skipLeadingWhitespace();
		if (!buffer.length)
			return;
		this.anythingElse();
	...
	***REMOVED***;
	...
	modes.beforeHTML.startTagHtml = function(name, attributes, selfClosing) ***REMOVED***
		tree.insertHtmlElement(attributes);
		tree.setInsertionMode('beforeHead');
	***REMOVED***;

	modes.beforeHTML.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		this.anythingElse();
		tree.insertionMode.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.beforeHTML.processEndTag = function(name) ***REMOVED***
		this.anythingElse();
		tree.insertionMode.processEndTag(name);
	***REMOVED***;

	modes.beforeHTML.anythingElse = function() ***REMOVED***
	...
	***REMOVED***;
	...
	modes.afterAfterBody.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		'-default': 'startTagOther'
	***REMOVED***;

	modes.afterAfterBody.processComment = function(data) ***REMOVED***
		tree.insertComment(data, tree.document);
	***REMOVED***;

	modes.afterAfterBody.processDoctype = function(data) ***REMOVED***
		modes.inBody.processDoctype(data);
	***REMOVED***;

	modes.afterAfterBody.startTagHtml = function(data, attributes) ***REMOVED***
		modes.inBody.startTagHtml(data, attributes);
	***REMOVED***;

	modes.afterAfterBody.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		tree.parseError('unexpected-start-tag', ***REMOVED***name: name***REMOVED***);
		tree.setInsertionMode('inBody');
		tree.insertionMode.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.afterAfterBody.endTagOther = function(name) ***REMOVED***
		tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
		tree.setInsertionMode('inBody');
		tree.insertionMode.processEndTag(name);
	***REMOVED***;

	modes.afterAfterBody.processCharacters = function(data) ***REMOVED***
		if (!isAllWhitespace(data.characters)) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.afterBody.end_tag_handlers = ***REMOVED***
		html: 'endTagHtml',
		'-default': 'endTagOther'
	***REMOVED***;

	modes.afterBody.processComment = function(data) ***REMOVED***
		tree.insertComment(data, tree.openElements.rootNode);
	***REMOVED***;

	modes.afterBody.processCharacters = function(data) ***REMOVED***
		if (!isAllWhitespace(data.characters)) ***REMOVED***
			tree.parseError('unexpected-char-after-body');
			tree.setInsertionMode('inBody');
			return tree.insertionMode.processCharacters(data);
	...
	***REMOVED***;
	...
	modes.afterBody.processStartTag = function(name, attributes, selfClosing) ***REMOVED***
		tree.parseError('unexpected-start-tag-after-body', ***REMOVED***name: name***REMOVED***);
		tree.setInsertionMode('inBody');
		tree.insertionMode.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.afterBody.endTagHtml = function(name) ***REMOVED***
		if (tree.context) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.afterBody.endTagOther = function(name) ***REMOVED***
		tree.parseError('unexpected-end-tag-after-body', ***REMOVED***name: name***REMOVED***);
		tree.setInsertionMode('inBody');
		tree.insertionMode.processEndTag(name);
	***REMOVED***;
	...
	modes.afterFrameset.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		noframes: 'startTagNoframes',
		'-default': 'startTagOther'
	***REMOVED***;

	modes.afterFrameset.end_tag_handlers = ***REMOVED***
		html: 'endTagHtml',
		'-default': 'endTagOther'
	***REMOVED***;

	modes.afterFrameset.processCharacters = function(buffer) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.afterFrameset.startTagNoframes = function(name, attributes) ***REMOVED***
		modes.inHead.processStartTag(name, attributes);
	***REMOVED***;

	modes.afterFrameset.startTagOther = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-start-tag-after-frameset", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.afterFrameset.endTagHtml = function(name) ***REMOVED***
		tree.setInsertionMode('afterAfterFrameset');
	***REMOVED***;

	modes.afterFrameset.endTagOther = function(name) ***REMOVED***
		tree.parseError("unexpected-end-tag-after-frameset", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.beforeHead = Object.create(modes.base);

	modes.beforeHead.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		head: 'startTagHead',
		'-default': 'startTagOther'
	***REMOVED***;

	modes.beforeHead.end_tag_handlers = ***REMOVED***
	...
	***REMOVED***;
	...
	modes.beforeHead.processEOF = function() ***REMOVED***
		this.startTagHead('head', []);
		tree.insertionMode.processEOF();
	***REMOVED***;

	modes.beforeHead.processCharacters = function(buffer) ***REMOVED***
		buffer.skipLeadingWhitespace();
		if (!buffer.length)
			return;
		this.startTagHead('head', []);
	...
	***REMOVED***;
	...
	modes.beforeHead.startTagHead = function(name, attributes) ***REMOVED***
		tree.insertHeadElement(attributes);
		tree.setInsertionMode('inHead');
	***REMOVED***;

	modes.beforeHead.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		this.startTagHead('head', []);
		tree.insertionMode.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.beforeHead.endTagImplyHead = function(name) ***REMOVED***
		this.startTagHead('head', []);
		tree.insertionMode.processEndTag(name);
	***REMOVED***;

	modes.beforeHead.endTagOther = function(name) ***REMOVED***
		tree.parseError('end-tag-after-implied-root', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inHead = Object.create(modes.base);

	modes.inHead.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		head: 'startTagHead',
		title: 'startTagTitle',
	...
	***REMOVED***;
	...
	modes.inHead.end_tag_handlers = ***REMOVED***
		head: 'endTagHead',
	...
	***REMOVED***;
	...
	modes.inHead.processEOF = function() ***REMOVED***
		var name = tree.currentStackItem().localName;
		if (['title', 'style', 'script'].indexOf(name) != -1) ***REMOVED***
			tree.parseError("expected-named-closing-tag-but-got-eof", ***REMOVED***name: name***REMOVED***);
			tree.popElement();
		***REMOVED***
	...
	***REMOVED***;
	...
	modes.inHead.processCharacters = function(buffer) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inHead.startTagHtml = function(name, attributes) ***REMOVED***
		modes.inBody.processStartTag(name, attributes);
	***REMOVED***;

	modes.inHead.startTagHead = function(name, attributes) ***REMOVED***
		tree.parseError('two-heads-are-not-better-than-one');
	***REMOVED***;

	modes.inHead.startTagTitle = function(name, attributes) ***REMOVED***
		tree.processGenericRCDATAStartTag(name, attributes);
	***REMOVED***;

	modes.inHead.startTagNoScript = function(name, attributes) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inHead.startTagNoFramesStyle = function(name, attributes) ***REMOVED***
		tree.processGenericRawTextStartTag(name, attributes);
	***REMOVED***;

	modes.inHead.startTagScript = function(name, attributes) ***REMOVED***
		tree.insertElement(name, attributes);
	...
	***REMOVED***;
	...
	modes.inHead.startTagBaseBasefontBgsoundLink = function(name, attributes) ***REMOVED***
		tree.insertSelfClosingElement(name, attributes);
	***REMOVED***;

	modes.inHead.startTagMeta = function(name, attributes) ***REMOVED***
		tree.insertSelfClosingElement(name, attributes);
	***REMOVED***;

	modes.inHead.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		this.anythingElse();
		tree.insertionMode.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.inHead.endTagHead = function(name) ***REMOVED***
		if (tree.openElements.item(tree.openElements.length - 1).localName == 'head') ***REMOVED***
			tree.openElements.pop();
		***REMOVED*** else ***REMOVED***
			tree.parseError('unexpected-end-tag', ***REMOVED***name: 'head'***REMOVED***);
		***REMOVED***
		tree.setInsertionMode('afterHead');
	***REMOVED***;

	modes.inHead.endTagHtmlBodyBr = function(name) ***REMOVED***
		this.anythingElse();
		tree.insertionMode.processEndTag(name);
	***REMOVED***;

	modes.inHead.endTagOther = function(name) ***REMOVED***
		tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inHead.anythingElse = function() ***REMOVED***
		this.endTagHead('head');
	***REMOVED***;

	modes.afterHead = Object.create(modes.base);

	modes.afterHead.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		head: 'startTagHead',
		body: 'startTagBody',
	...
	***REMOVED***;
	...
	modes.afterHead.end_tag_handlers = ***REMOVED***
	...
	***REMOVED***;
	...
	modes.afterHead.processEOF = function() ***REMOVED***
		this.anythingElse();
		tree.insertionMode.processEOF();
	***REMOVED***;

	modes.afterHead.processCharacters = function(buffer) ***REMOVED***
		var leadingWhitespace = buffer.takeLeadingWhitespace();
		if (leadingWhitespace)
			tree.insertText(leadingWhitespace);
		if (!buffer.length)
	...
	***REMOVED***;
	...
	modes.afterHead.startTagHtml = function(name, attributes) ***REMOVED***
		modes.inBody.processStartTag(name, attributes);
	***REMOVED***;

	modes.afterHead.startTagBody = function(name, attributes) ***REMOVED***
		tree.framesetOk = false;
		tree.insertBodyElement(attributes);
		tree.setInsertionMode('inBody');
	***REMOVED***;

	modes.afterHead.startTagFrameset = function(name, attributes) ***REMOVED***
		tree.insertElement(name, attributes);
		tree.setInsertionMode('inFrameset');
	***REMOVED***;

	modes.afterHead.startTagFromHead = function(name, attributes, selfClosing) ***REMOVED***
		tree.parseError("unexpected-start-tag-out-of-my-head", ***REMOVED***name: name***REMOVED***);
	...
	***REMOVED***;
	...
	modes.afterHead.startTagHead = function(name, attributes, selfClosing) ***REMOVED***
		tree.parseError('unexpected-start-tag', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.afterHead.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		this.anythingElse();
		tree.insertionMode.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.afterHead.endTagBodyHtmlBr = function(name) ***REMOVED***
		this.anythingElse();
		tree.insertionMode.processEndTag(name);
	***REMOVED***;

	modes.afterHead.endTagOther = function(name) ***REMOVED***
		tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.afterHead.anythingElse = function() ***REMOVED***
	...
	***REMOVED***
	...
	modes.inBody.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
	...
	***REMOVED***;
	...
	modes.inBody.end_tag_handlers = ***REMOVED***
		p: 'endTagP',
		body: 'endTagBody',
		html: 'endTagHtml',
		address: 'endTagBlock',
	...
	***REMOVED***;
	...
	modes.inBody.processCharacters = function(buffer) ***REMOVED***
		if (tree.shouldSkipLeadingNewline) ***REMOVED***
			tree.shouldSkipLeadingNewline = false;
			buffer.skipAtMostOneLeadingNewline();
		***REMOVED***
		tree.reconstructActiveFormattingElements();
		var characters = buffer.takeRemaining();
		characters = characters.replace(/\u0000/g, function(match, index)***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.startTagHtml = function(name, attributes) ***REMOVED***
		tree.parseError('non-html-root');
		tree.addAttributesToElement(tree.openElements.rootNode, attributes);
	***REMOVED***;

	modes.inBody.startTagProcessInHead = function(name, attributes) ***REMOVED***
		modes.inHead.processStartTag(name, attributes);
	***REMOVED***;

	modes.inBody.startTagBody = function(name, attributes) ***REMOVED***
		tree.parseError('unexpected-start-tag', ***REMOVED***name: 'body'***REMOVED***);
	...
	***REMOVED***;
	...
	modes.inBody.startTagFrameset = function(name, attributes) ***REMOVED***
		tree.parseError('unexpected-start-tag', ***REMOVED***name: 'frameset'***REMOVED***);
		if (tree.openElements.length == 1 ||
			tree.openElements.item(1).localName != 'body') ***REMOVED***
			assert.ok(tree.context);
		***REMOVED*** else if (tree.framesetOk) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.startTagCloseP = function(name, attributes) ***REMOVED***
		if (tree.openElements.inButtonScope('p'))
			this.endTagP('p');
		tree.insertElement(name, attributes);
	***REMOVED***;

	modes.inBody.startTagPreListing = function(name, attributes) ***REMOVED***
		if (tree.openElements.inButtonScope('p'))
			this.endTagP('p');
		tree.insertElement(name, attributes);
		tree.framesetOk = false;
	...
	***REMOVED***;
	...
	modes.inBody.startTagForm = function(name, attributes) ***REMOVED***
		if (tree.form) ***REMOVED***
			tree.parseError('unexpected-start-tag', ***REMOVED***name: name***REMOVED***);
		***REMOVED*** else ***REMOVED***
			if (tree.openElements.inButtonScope('p'))
				this.endTagP('p');
	...
	***REMOVED***;
	...
	modes.inBody.startTagRpRt = function(name, attributes) ***REMOVED***
		if (tree.openElements.inScope('ruby')) ***REMOVED***
			tree.generateImpliedEndTags();
			if (tree.currentStackItem().localName != 'ruby') ***REMOVED***
				tree.parseError('unexpected-start-tag', ***REMOVED***name: name***REMOVED***);
			***REMOVED***
		***REMOVED***
		tree.insertElement(name, attributes);
	***REMOVED***;
	...
	modes.inBody.startTagListItem = function(name, attributes) ***REMOVED***
		var stopNames = ***REMOVED***li: ['li'], dd: ['dd', 'dt'], dt: ['dd', 'dt']***REMOVED***;
		var stopName = stopNames[name];

		var els = tree.openElements;
		for (var i = els.length - 1; i >= 0; i--) ***REMOVED***
			var node = els.item(i);
			if (stopName.indexOf(node.localName) != -1) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.startTagPlaintext = function(name, attributes) ***REMOVED***
		if (tree.openElements.inButtonScope('p'))
			this.endTagP('p');
		tree.insertElement(name, attributes);
	...
	***REMOVED***;
	...
	modes.inBody.startTagHeading = function(name, attributes) ***REMOVED***
		if (tree.openElements.inButtonScope('p'))
			this.endTagP('p');
		if (tree.currentStackItem().isNumberedHeader()) ***REMOVED***
			tree.parseError('unexpected-start-tag', ***REMOVED***name: name***REMOVED***);
			tree.popElement();
		***REMOVED***
		tree.insertElement(name, attributes);
	***REMOVED***;
	...
	modes.inBody.startTagA = function(name, attributes) ***REMOVED***
		var activeA = tree.elementInActiveFormattingElements('a');
		if (activeA) ***REMOVED***
			tree.parseError("unexpected-start-tag-implies-end-tag", ***REMOVED***startName: "a", endName: "a"***REMOVED***);
	...
	***REMOVED***;
	...
	modes.inBody.startTagFormatting = function(name, attributes) ***REMOVED***
		tree.reconstructActiveFormattingElements();
		tree.insertFormattingElement(name, attributes);
	***REMOVED***;

	modes.inBody.startTagNobr = function(name, attributes) ***REMOVED***
		tree.reconstructActiveFormattingElements();
		if (tree.openElements.inScope('nobr')) ***REMOVED***
			tree.parseError("unexpected-start-tag-implies-end-tag", ***REMOVED***startName: 'nobr', endName: 'nobr'***REMOVED***);
	...
	***REMOVED***;
	...
	modes.inBody.startTagButton = function(name, attributes) ***REMOVED***
		if (tree.openElements.inScope('button')) ***REMOVED***
			tree.parseError('unexpected-start-tag-implies-end-tag', ***REMOVED***startName: 'button', endName: 'button'***REMOVED***);
	...
	***REMOVED***;
	...
	modes.inBody.startTagAppletMarqueeObject = function(name, attributes) ***REMOVED***
		tree.reconstructActiveFormattingElements();
		tree.insertElement(name, attributes);
	...
	***REMOVED***;
	...
	modes.inBody.endTagAppletMarqueeObject = function(name) ***REMOVED***
		if (!tree.openElements.inScope(name)) ***REMOVED***
			tree.parseError("unexpected-end-tag", ***REMOVED***name: name***REMOVED***);
		***REMOVED*** else ***REMOVED***
			tree.generateImpliedEndTags();
			if (tree.currentStackItem().localName != name) ***REMOVED***
				tree.parseError('end-tag-too-early', ***REMOVED***name: name***REMOVED***);
			***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.startTagXmp = function(name, attributes) ***REMOVED***
		if (tree.openElements.inButtonScope('p'))
	...
	***REMOVED***;
	...
	modes.inBody.startTagTable = function(name, attributes) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.startTagVoidFormatting = function(name, attributes) ***REMOVED***
		tree.reconstructActiveFormattingElements();
		tree.insertSelfClosingElement(name, attributes);
		tree.framesetOk = false;
	***REMOVED***;

	modes.inBody.startTagParamSourceTrack = function(name, attributes) ***REMOVED***
		tree.insertSelfClosingElement(name, attributes);
	***REMOVED***;

	modes.inBody.startTagHr = function(name, attributes) ***REMOVED***
		if (tree.openElements.inButtonScope('p'))
			this.endTagP('p');
		tree.insertSelfClosingElement(name, attributes);
		tree.framesetOk = false;
	***REMOVED***;
	...
	modes.inBody.startTagImage = function(name, attributes) ***REMOVED***
		tree.parseError('unexpected-start-tag-treated-as', ***REMOVED***originalName: 'image', newName: 'img'***REMOVED***);
		this.processStartTag('img', attributes);
	***REMOVED***;

	modes.inBody.startTagInput = function(name, attributes) ***REMOVED***
		var currentFramesetOk = tree.framesetOk;
		this.startTagVoidFormatting(name, attributes);
		for (var key in attributes) ***REMOVED***
			if (attributes[key].nodeName == 'type') ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.startTagIsindex = function(name, attributes) ***REMOVED***
		tree.parseError('deprecated-tag', ***REMOVED***name: 'isindex'***REMOVED***);
		...
		for (var key in attributes) ***REMOVED***
			switch (attributes[key].nodeName) ***REMOVED***
				case 'action':
					formAttributes.push(***REMOVED***nodeName: 'action',
						nodeValue: attributes[key].nodeValue***REMOVED***);
					break;
				case 'prompt':
				...
				case 'name':
					break;
				default:
					inputAttributes.push(***REMOVED***nodeName: attributes[key].nodeName,
						nodeValue: attributes[key].nodeValue***REMOVED***);
			***REMOVED***
		***REMOVED***
		inputAttributes.push(***REMOVED***nodeName: 'name', nodeValue: 'isindex'***REMOVED***);
	...
	***REMOVED***;
	...
	modes.inBody.startTagTextarea = function(name, attributes) ***REMOVED***
		tree.insertElement(name, attributes);
	...
	***REMOVED***;
	...
	modes.inBody.startTagIFrame = function(name, attributes) ***REMOVED***
		tree.framesetOk = false;
		this.startTagRawText(name, attributes);
	***REMOVED***;

	modes.inBody.startTagRawText = function(name, attributes) ***REMOVED***
		tree.processGenericRawTextStartTag(name, attributes);
	***REMOVED***;

	modes.inBody.startTagSelect = function(name, attributes) ***REMOVED***
		tree.reconstructActiveFormattingElements();
		tree.insertElement(name, attributes);
		tree.framesetOk = false;
		...
		if (insertionModeName == 'inTable' ||
			...
			insertionModeName == 'inCell') ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.startTagMisplaced = function(name, attributes) ***REMOVED***
		tree.parseError('unexpected-start-tag-ignored', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inBody.endTagMisplaced = function(name) ***REMOVED***
		tree.parseError("unexpected-end-tag", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inBody.endTagBr = function(name) ***REMOVED***
		tree.parseError("unexpected-end-tag-treated-as", ***REMOVED***originalName: "br", newName: "br element"***REMOVED***);
		tree.reconstructActiveFormattingElements();
		tree.insertElement(name, []);
		tree.popElement();
	***REMOVED***;

	modes.inBody.startTagOptionOptgroup = function(name, attributes) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.startTagOther = function(name, attributes) ***REMOVED***
		tree.reconstructActiveFormattingElements();
		tree.insertElement(name, attributes);
	***REMOVED***;

	modes.inBody.endTagOther = function(name) ***REMOVED***
		var node;
		for (var i = tree.openElements.length - 1; i > 0; i--) ***REMOVED***
			node = tree.openElements.item(i);
			if (node.localName == name) ***REMOVED***
				tree.generateImpliedEndTags(name);
				if (tree.currentStackItem().localName != name)
					tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
				tree.openElements.remove_openElements_until(function(x) ***REMOVED***return x === node;***REMOVED***);
				break;
			***REMOVED***
			if (node.isSpecial()) ***REMOVED***
				tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
				break;
			***REMOVED***
		***REMOVED***
	***REMOVED***;
	...
	modes.inBody.startTagMath = function(name, attributes, selfClosing) ***REMOVED***
		tree.reconstructActiveFormattingElements();
	...
	***REMOVED***;
	...
	modes.inBody.startTagSVG = function(name, attributes, selfClosing) ***REMOVED***
		tree.reconstructActiveFormattingElements();
	...
	***REMOVED***;
	...
	modes.inBody.endTagP = function(name) ***REMOVED***
		if (!tree.openElements.inButtonScope('p')) ***REMOVED***
			tree.parseError('unexpected-end-tag', ***REMOVED***name: 'p'***REMOVED***);
			this.startTagCloseP('p', []);
			this.endTagP('p');
		***REMOVED*** else ***REMOVED***
			tree.generateImpliedEndTags('p');
			if (tree.currentStackItem().localName != 'p')
				tree.parseError('unexpected-implied-end-tag', ***REMOVED***name: 'p'***REMOVED***);
			tree.openElements.popUntilPopped(name);
		***REMOVED***
	***REMOVED***;

	modes.inBody.endTagBody = function(name) ***REMOVED***
		if (!tree.openElements.inScope('body')) ***REMOVED***
			tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
			return;
		***REMOVED***
		if (tree.currentStackItem().localName != 'body') ***REMOVED***
			tree.parseError('expected-one-end-tag-but-got-another', ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.endTagHtml = function(name) ***REMOVED***
		if (!tree.openElements.inScope('body')) ***REMOVED***
			tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
			return;
		***REMOVED***
	...
	***REMOVED***;
	...
	modes.inBody.endTagBlock = function(name) ***REMOVED***
		if (!tree.openElements.inScope(name)) ***REMOVED***
			tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
		***REMOVED*** else ***REMOVED***
			tree.generateImpliedEndTags();
	...
	***REMOVED***;
	...
	modes.inBody.endTagForm = function(name)  ***REMOVED***
		var node = tree.form;
		tree.form = null;
		if (!node || !tree.openElements.inScope(name)) ***REMOVED***
			tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
		***REMOVED*** else ***REMOVED***
			tree.generateImpliedEndTags();
			if (tree.currentStackItem() != node) ***REMOVED***
				tree.parseError('end-tag-too-early-ignored', ***REMOVED***name: 'form'***REMOVED***);
			***REMOVED***
			tree.openElements.remove(node);
		***REMOVED***
	***REMOVED***;

	modes.inBody.endTagListItem = function(name) ***REMOVED***
		if (!tree.openElements.inListItemScope(name)) ***REMOVED***
			tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
		***REMOVED*** else ***REMOVED***
			tree.generateImpliedEndTags(name);
			if (tree.currentStackItem().localName != name)
	...
	***REMOVED***;
	...
	modes.inBody.endTagHeading = function(name) ***REMOVED***
		if (!tree.openElements.hasNumberedHeaderElementInScope()) ***REMOVED***
			tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
			return;
		***REMOVED***
		tree.generateImpliedEndTags();
		...
		tree.openElements.remove_openElements_until(function(e) ***REMOVED***
			return e.isNumberedHeader();
		***REMOVED***);
	***REMOVED***;

	modes.inBody.endTagFormatting = function(name, attributes) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inCaption.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
	...
	***REMOVED***;
	...
	modes.inCaption.end_tag_handlers = ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inCaption.processCharacters = function(data) ***REMOVED***
		modes.inBody.processCharacters(data);
	***REMOVED***;

	modes.inCaption.startTagTableElement = function(name, attributes) ***REMOVED***
		tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
	...
	***REMOVED***;
	...
	modes.inCaption.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		modes.inBody.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.inCaption.endTagCaption = function(name) ***REMOVED***
		if (!tree.openElements.inTableScope('caption')) ***REMOVED***
			assert.ok(tree.context);
			tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
		***REMOVED*** else ***REMOVED***
			tree.generateImpliedEndTags();
			if (tree.currentStackItem().localName != 'caption') ***REMOVED***
				tree.parseError('expected-one-end-tag-but-got-another', ***REMOVED***
					gotName: "caption",
					expectedName: tree.currentStackItem().localName
				***REMOVED***);
	...
	***REMOVED***;
	...
	modes.inCaption.endTagTable = function(name) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inCaption.endTagIgnore = function(name) ***REMOVED***
		tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inCaption.endTagOther = function(name) ***REMOVED***
		modes.inBody.processEndTag(name);
	***REMOVED***;

	modes.inCell = Object.create(modes.base);

	modes.inCell.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
	...
	***REMOVED***;
	...
	modes.inCell.end_tag_handlers = ***REMOVED***
		td: 'endTagTableCell',
		th: 'endTagTableCell',
		body: 'endTagIgnore',
	...
	***REMOVED***;
	...
	modes.inCell.processCharacters = function(data) ***REMOVED***
		modes.inBody.processCharacters(data);
	***REMOVED***;

	modes.inCell.startTagTableOther = function(name, attributes, selfClosing) ***REMOVED***
		if (tree.openElements.inTableScope('td') || tree.openElements.inTableScope('th')) ***REMOVED***
			this.closeCell();
			tree.insertionMode.processStartTag(name, attributes, selfClosing);
		***REMOVED*** else ***REMOVED***
			tree.parseError('unexpected-start-tag', ***REMOVED***name: name***REMOVED***);
	...
	***REMOVED***;
	...
	modes.inCell.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		modes.inBody.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.inCell.endTagTableCell = function(name) ***REMOVED***
		if (tree.openElements.inTableScope(name)) ***REMOVED***
			tree.generateImpliedEndTags(name);
			if (tree.currentStackItem().localName != name.toLowerCase()) ***REMOVED***
				tree.parseError('unexpected-cell-end-tag', ***REMOVED***name: name***REMOVED***);
				tree.openElements.popUntilPopped(name);
			***REMOVED*** else ***REMOVED***
				tree.popElement();
			***REMOVED***
	...
	***REMOVED***;
	...
	modes.inCell.endTagIgnore = function(name) ***REMOVED***
		tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inCell.endTagImply = function(name) ***REMOVED***
		if (tree.openElements.inTableScope(name)) ***REMOVED***
			this.closeCell();
			tree.insertionMode.processEndTag(name);
		***REMOVED*** else ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inCell.endTagOther = function(name) ***REMOVED***
		modes.inBody.processEndTag(name);
	***REMOVED***;

	modes.inCell.closeCell = function() ***REMOVED***
		if (tree.openElements.inTableScope('td')) ***REMOVED***
			this.endTagTableCell('td');
		***REMOVED*** else if (tree.openElements.inTableScope('th')) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inColumnGroup.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		col: 'startTagCol',
		'-default': 'startTagOther'
	***REMOVED***;

	modes.inColumnGroup.end_tag_handlers = ***REMOVED***
		colgroup: 'endTagColgroup',
		col: 'endTagCol',
		'-default': 'endTagOther'
	***REMOVED***;

	modes.inColumnGroup.ignoreEndTagColgroup = function() ***REMOVED***
		return tree.currentStackItem().localName == 'html';
	***REMOVED***;

	modes.inColumnGroup.processCharacters = function(buffer) ***REMOVED***
		var leadingWhitespace = buffer.takeLeadingWhitespace();
		if (leadingWhitespace)
			tree.insertText(leadingWhitespace);
		if (!buffer.length)
	...
	***REMOVED***;
	...
	modes.inColumnGroup.startTagCol = function(name, attributes) ***REMOVED***
		tree.insertSelfClosingElement(name, attributes);
	***REMOVED***;

	modes.inColumnGroup.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		var ignoreEndTag = this.ignoreEndTagColgroup();
		this.endTagColgroup('colgroup');
		if (!ignoreEndTag) tree.insertionMode.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.inColumnGroup.endTagColgroup = function(name) ***REMOVED***
		if (this.ignoreEndTagColgroup()) ***REMOVED***
			assert.ok(tree.context);
			tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
		***REMOVED*** else ***REMOVED***
			tree.popElement();
	...
	***REMOVED***;
	...
	modes.inColumnGroup.endTagCol = function(name) ***REMOVED***
		tree.parseError("no-end-tag", ***REMOVED***name: 'col'***REMOVED***);
	***REMOVED***;

	modes.inColumnGroup.endTagOther = function(name) ***REMOVED***
		var ignoreEndTag = this.ignoreEndTagColgroup();
		this.endTagColgroup('colgroup');
		if (!ignoreEndTag) tree.insertionMode.processEndTag(name) ;
	***REMOVED***;
	...
	modes.inForeignContent.processStartTag = function(name, attributes, selfClosing) ***REMOVED***
		if (['b', 'big', 'blockquote', 'body', 'br', 'center', 'code', 'dd', 'div', 'dl', 'dt', 'em', 'embed', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'hr', 'i', 'img', 'li', 'listing', 'menu', 'meta', 'nobr', 'ol', 'p', 'pre', 'ruby', 's', 'small', 'span', 'strong', 'strike', 'sub', 'sup', 'table', 'tt', 'u', 'ul', 'var'].indexOf(name) != -1
				|| (name == 'font' && attributes.some(function(attr)***REMOVED*** return ['color', 'face', 'size'].indexOf(attr.nodeName) >= 0 ***REMOVED***))) ***REMOVED***
			tree.parseError('unexpected-html-element-in-foreign-content', ***REMOVED***name: name***REMOVED***);
			while (tree.currentStackItem().isForeign()
				&& !tree.currentStackItem().isHtmlIntegrationPoint()
				&& !tree.currentStackItem().isMathMLTextIntegrationPoint()) ***REMOVED***
				tree.openElements.pop();
			***REMOVED***
			tree.insertionMode.processStartTag(name, attributes, selfClosing);
			return;
		***REMOVED***
		if (tree.currentStackItem().namespaceURI == "http://www.w3.org/1998/Math/MathML") ***REMOVED***
			attributes = tree.adjustMathMLAttributes(attributes);
		***REMOVED***
		if (tree.currentStackItem().namespaceURI == "http://www.w3.org/2000/svg") ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inForeignContent.processEndTag = function(name) ***REMOVED***
		...
		while (true) ***REMOVED***
			if (index === 0)
				break;
			if (node.localName.toLowerCase() == name) ***REMOVED***
				while (tree.openElements.pop() != node);
				break;
			***REMOVED***
			index -= 1;
			node = tree.openElements.item(index);
			if (node.isForeign()) ***REMOVED***
				continue;
			***REMOVED*** else ***REMOVED***
				tree.insertionMode.processEndTag(name);
				break;
	...
	***REMOVED***;
	...
	modes.inForeignContent.processCharacters = function(buffer) ***REMOVED***
		var characters = buffer.takeRemaining();
		characters = characters.replace(/\u0000/g, function(match, index)***REMOVED***
			tree.parseError('invalid-codepoint');
			return '\uFFFD';
	...
	***REMOVED***;
	...
	modes.inHeadNoscript.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
	...
	***REMOVED***;
	...
	modes.inHeadNoscript.end_tag_handlers = ***REMOVED***
		noscript: 'endTagNoscript',
		br: 'endTagBr',
		'-default': 'endTagOther'
	***REMOVED***;

	modes.inHeadNoscript.processCharacters = function(buffer) ***REMOVED***
		var leadingWhitespace = buffer.takeLeadingWhitespace();
		if (leadingWhitespace)
			tree.insertText(leadingWhitespace);
		if (!buffer.length)
	...
	***REMOVED***;
	...
	modes.inHeadNoscript.processComment = function(data) ***REMOVED***
		modes.inHead.processComment(data);
	***REMOVED***;

	modes.inHeadNoscript.startTagBasefontBgsoundLinkMetaNoframesStyle = function(name, attributes) ***REMOVED***
		modes.inHead.processStartTag(name, attributes);
	***REMOVED***;

	modes.inHeadNoscript.startTagHeadNoscript = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-start-tag-in-frameset", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inHeadNoscript.startTagOther = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-start-tag-in-frameset", ***REMOVED***name: name***REMOVED***);
		this.anythingElse();
		tree.insertionMode.processStartTag(name, attributes);
	***REMOVED***;

	modes.inHeadNoscript.endTagBr = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-end-tag-in-frameset", ***REMOVED***name: name***REMOVED***);
		this.anythingElse();
		tree.insertionMode.processEndTag(name, attributes);
	***REMOVED***;

	modes.inHeadNoscript.endTagNoscript = function(name, attributes) ***REMOVED***
		tree.popElement();
		tree.setInsertionMode('inHead');
	***REMOVED***;

	modes.inHeadNoscript.endTagOther = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-end-tag-in-frameset", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inHeadNoscript.anythingElse = function() ***REMOVED***
		tree.popElement();
		tree.setInsertionMode('inHead');
	***REMOVED***;
	...
	modes.inFrameset.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		frameset: 'startTagFrameset',
		frame: 'startTagFrame',
		noframes: 'startTagNoframes',
	...
	***REMOVED***;
	...
	modes.inFrameset.end_tag_handlers = ***REMOVED***
		frameset: 'endTagFrameset',
		noframes: 'endTagNoframes',
		'-default': 'endTagOther'
	***REMOVED***;

	modes.inFrameset.processCharacters = function(data) ***REMOVED***
		tree.parseError("unexpected-char-in-frameset");
	***REMOVED***;

	modes.inFrameset.startTagFrameset = function(name, attributes) ***REMOVED***
		tree.insertElement(name, attributes);
	***REMOVED***;

	modes.inFrameset.startTagFrame = function(name, attributes) ***REMOVED***
		tree.insertSelfClosingElement(name, attributes);
	***REMOVED***;

	modes.inFrameset.startTagNoframes = function(name, attributes) ***REMOVED***
		modes.inBody.processStartTag(name, attributes);
	***REMOVED***;

	modes.inFrameset.startTagOther = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-start-tag-in-frameset", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inFrameset.endTagFrameset = function(name, attributes) ***REMOVED***
		if (tree.currentStackItem().localName == 'html') ***REMOVED***
			tree.parseError("unexpected-frameset-in-frameset-innerhtml");
		***REMOVED*** else ***REMOVED***
			tree.popElement();
		***REMOVED***

		if (!tree.context && tree.currentStackItem().localName != 'frameset') ***REMOVED***
			tree.setInsertionMode('afterFrameset');
		***REMOVED***
	***REMOVED***;

	modes.inFrameset.endTagNoframes = function(name) ***REMOVED***
		modes.inBody.processEndTag(name);
	***REMOVED***;

	modes.inFrameset.endTagOther = function(name) ***REMOVED***
		tree.parseError("unexpected-end-tag-in-frameset", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inTable = Object.create(modes.base);

	modes.inTable.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
	...
	***REMOVED***;
	...
	modes.inTable.end_tag_handlers = ***REMOVED***
		table: 'endTagTable',
		body: 'endTagIgnore',
		caption: 'endTagIgnore',
		col: 'endTagIgnore',
	...
	***REMOVED***;
	...
	modes.inTable.processCharacters =  function(data) ***REMOVED***
		if (tree.currentStackItem().isFosterParenting()) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inTable.startTagCaption = function(name, attributes) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inTable.startTagColgroup = function(name, attributes) ***REMOVED***
		tree.openElements.popUntilTableScopeMarker();
		tree.insertElement(name, attributes);
		tree.setInsertionMode('inColumnGroup');
	***REMOVED***;

	modes.inTable.startTagCol = function(name, attributes) ***REMOVED***
		this.startTagColgroup('colgroup', []);
		tree.insertionMode.processStartTag(name, attributes);
	***REMOVED***;

	modes.inTable.startTagRowGroup = function(name, attributes) ***REMOVED***
		tree.openElements.popUntilTableScopeMarker();
		tree.insertElement(name, attributes);
		tree.setInsertionMode('inTableBody');
	***REMOVED***;

	modes.inTable.startTagImplyTbody = function(name, attributes) ***REMOVED***
		this.startTagRowGroup('tbody', []);
		tree.insertionMode.processStartTag(name, attributes);
	***REMOVED***;

	modes.inTable.startTagTable = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-start-tag-implies-end-tag",
				***REMOVED***startName: "table", endName: "table"***REMOVED***);
		tree.insertionMode.processEndTag('table');
		if (!tree.context) tree.insertionMode.processStartTag(name, attributes);
	***REMOVED***;

	modes.inTable.startTagStyleScript = function(name, attributes) ***REMOVED***
		modes.inHead.processStartTag(name, attributes);
	***REMOVED***;

	modes.inTable.startTagInput = function(name, attributes) ***REMOVED***
		for (var key in attributes) ***REMOVED***
			if (attributes[key].nodeName.toLowerCase() == 'type') ***REMOVED***
				if (attributes[key].nodeValue.toLowerCase() == 'hidden') ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inTable.startTagForm = function(name, attributes) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inTable.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		tree.parseError("unexpected-start-tag-implies-table-voodoo", ***REMOVED***name: name***REMOVED***);
		tree.redirectAttachToFosterParent = true;
		modes.inBody.processStartTag(name, attributes, selfClosing);
		tree.redirectAttachToFosterParent = false;
	***REMOVED***;

	modes.inTable.endTagTable = function(name) ***REMOVED***
		if (tree.openElements.inTableScope(name)) ***REMOVED***
			tree.generateImpliedEndTags();
			if (tree.currentStackItem().localName != name) ***REMOVED***
				tree.parseError("end-tag-too-early-named", ***REMOVED***gotName: 'table', expectedName: tree.currentStackItem().localName***REMOVED***);
			***REMOVED***
	...
	***REMOVED***;
	...
	modes.inTable.endTagIgnore = function(name) ***REMOVED***
		tree.parseError("unexpected-end-tag", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inTable.endTagOther = function(name) ***REMOVED***
		tree.parseError("unexpected-end-tag-implies-table-voodoo", ***REMOVED***name: name***REMOVED***);
		tree.redirectAttachToFosterParent = true;
		modes.inBody.processEndTag(name);
		tree.redirectAttachToFosterParent = false;
	***REMOVED***;
	...
	modes.inTableText.flushCharacters = function() ***REMOVED***
		var characters = tree.pendingTableCharacters.join('');
		if (!isAllWhitespace(characters)) ***REMOVED***
			tree.redirectAttachToFosterParent = true;
			tree.reconstructActiveFormattingElements();
			tree.insertText(characters);
			tree.framesetOk = false;
	...
	***REMOVED***;
	...
	modes.inTableText.processComment = function(data) ***REMOVED***
		this.flushCharacters();
		tree.setInsertionMode(tree.originalInsertionMode);
		tree.insertionMode.processComment(data);
	***REMOVED***;

	modes.inTableText.processEOF = function(data) ***REMOVED***
		this.flushCharacters();
		tree.setInsertionMode(tree.originalInsertionMode);
		tree.insertionMode.processEOF();
	***REMOVED***;

	modes.inTableText.processCharacters = function(buffer) ***REMOVED***
		var characters = buffer.takeRemaining();
		characters = characters.replace(/\u0000/g, function(match, index)***REMOVED***
			tree.parseError("invalid-codepoint");
			return '';
	...
	***REMOVED***;
	...
	modes.inTableText.processStartTag = function(name, attributes, selfClosing) ***REMOVED***
		this.flushCharacters();
		tree.setInsertionMode(tree.originalInsertionMode);
		tree.insertionMode.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.inTableText.processEndTag = function(name, attributes) ***REMOVED***
		this.flushCharacters();
		tree.setInsertionMode(tree.originalInsertionMode);
		tree.insertionMode.processEndTag(name, attributes);
	***REMOVED***;
	...
	modes.inTableBody.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		tr: 'startTagTr',
	...
	***REMOVED***;
	...
	modes.inTableBody.end_tag_handlers = ***REMOVED***
		table: 'endTagTable',
	...
	***REMOVED***;
	...
	modes.inTableBody.processCharacters = function(data) ***REMOVED***
		modes.inTable.processCharacters(data);
	***REMOVED***;

	modes.inTableBody.startTagTr = function(name, attributes) ***REMOVED***
		tree.openElements.popUntilTableBodyScopeMarker();
		tree.insertElement(name, attributes);
		tree.setInsertionMode('inRow');
	***REMOVED***;

	modes.inTableBody.startTagTableCell = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-cell-in-table-body", ***REMOVED***name: name***REMOVED***);
		this.startTagTr('tr', []);
		tree.insertionMode.processStartTag(name, attributes);
	***REMOVED***;

	modes.inTableBody.startTagTableOther = function(name, attributes) ***REMOVED***
		if (tree.openElements.inTableScope('tbody') ||  tree.openElements.inTableScope('thead') || tree.openElements.inTableScope('tfoot')) ***REMOVED***
			tree.openElements.popUntilTableBodyScopeMarker();
	...
	***REMOVED***;
	...
	modes.inTableBody.startTagOther = function(name, attributes) ***REMOVED***
		modes.inTable.processStartTag(name, attributes);
	***REMOVED***;

	modes.inTableBody.endTagTableRowGroup = function(name) ***REMOVED***
		if (tree.openElements.inTableScope(name)) ***REMOVED***
			tree.openElements.popUntilTableBodyScopeMarker();
			tree.popElement();
			tree.setInsertionMode('inTable');
		***REMOVED*** else ***REMOVED***
			tree.parseError('unexpected-end-tag-in-table-body', ***REMOVED***name: name***REMOVED***);
		***REMOVED***
	***REMOVED***;

	modes.inTableBody.endTagTable = function(name) ***REMOVED***
		if (tree.openElements.inTableScope('tbody') ||  tree.openElements.inTableScope('thead') || tree.openElements.inTableScope('tfoot')) ***REMOVED***
			tree.openElements.popUntilTableBodyScopeMarker();
			this.endTagTableRowGroup(tree.currentStackItem().localName);
			tree.insertionMode.processEndTag(name);
	...
	***REMOVED***;
	...
	modes.inTableBody.endTagIgnore = function(name) ***REMOVED***
		tree.parseError("unexpected-end-tag-in-table-body", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inTableBody.endTagOther = function(name) ***REMOVED***
		modes.inTable.processEndTag(name);
	***REMOVED***;

	modes.inSelect = Object.create(modes.base);

	modes.inSelect.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
	...
	***REMOVED***;
	...
	modes.inSelect.end_tag_handlers = ***REMOVED***
		option: 'endTagOption',
	...
	***REMOVED***;
	...
	modes.inSelect.processCharacters = function(buffer) ***REMOVED***
		var data = buffer.takeRemaining();
		data = data.replace(/\u0000/g, function(match, index)***REMOVED***
			tree.parseError("invalid-codepoint");
			return '';
		***REMOVED***);
		if (!data)
	...
	***REMOVED***;
	...
	modes.inSelect.startTagOption = function(name, attributes) ***REMOVED***
		if (tree.currentStackItem().localName == 'option')
			tree.popElement();
		tree.insertElement(name, attributes);
	***REMOVED***;

	modes.inSelect.startTagOptgroup = function(name, attributes) ***REMOVED***
		if (tree.currentStackItem().localName == 'option')
			tree.popElement();
	...
	***REMOVED***;
	...
	modes.inSelect.endTagOption = function(name) ***REMOVED***
		if (tree.currentStackItem().localName !== 'option') ***REMOVED***
			tree.parseError('unexpected-end-tag-in-select', ***REMOVED***name: name***REMOVED***);
			return;
		***REMOVED***
		tree.popElement();
	***REMOVED***;

	modes.inSelect.endTagOptgroup = function(name) ***REMOVED***
		if (tree.currentStackItem().localName == 'option' && tree.openElements.item(tree.openElements.length - 2).localName == 'optgroup') ***REMOVED***
			tree.popElement();
		***REMOVED***
		if (tree.currentStackItem().localName == 'optgroup') ***REMOVED***
			tree.popElement();
		***REMOVED*** else ***REMOVED***
			tree.parseError('unexpected-end-tag-in-select', ***REMOVED***name: 'optgroup'***REMOVED***);
		***REMOVED***
	***REMOVED***;

	modes.inSelect.startTagSelect = function(name) ***REMOVED***
		tree.parseError("unexpected-select-in-select");
		this.endTagSelect('select');
	***REMOVED***;

	modes.inSelect.endTagSelect = function(name) ***REMOVED***
		if (tree.openElements.inTableScope('select')) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inSelect.startTagInput = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-input-in-select");
		if (tree.openElements.inSelectScope('select')) ***REMOVED***
			this.endTagSelect('select');
			tree.insertionMode.processStartTag(name, attributes);
		***REMOVED***
	***REMOVED***;

	modes.inSelect.startTagScript = function(name, attributes) ***REMOVED***
		modes.inHead.processStartTag(name, attributes);
	***REMOVED***;

	modes.inSelect.endTagTableElements = function(name) ***REMOVED***
		tree.parseError('unexpected-end-tag-in-select', ***REMOVED***name: name***REMOVED***);
		if (tree.openElements.inTableScope(name)) ***REMOVED***
			this.endTagSelect('select');
			tree.insertionMode.processEndTag(name);
	...
	***REMOVED***;
	...
	modes.inSelect.startTagOther = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-start-tag-in-select", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inSelect.endTagOther = function(name) ***REMOVED***
		tree.parseError('unexpected-end-tag-in-select', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inSelectInTable = Object.create(modes.base);

	modes.inSelectInTable.start_tag_handlers = ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inSelectInTable.end_tag_handlers = ***REMOVED***
		caption: 'endTagTable',
		table: 'endTagTable',
		tbody: 'endTagTable',
		tfoot: 'endTagTable',
	...
	***REMOVED***;
	...
	modes.inSelectInTable.processCharacters = function(data) ***REMOVED***
		modes.inSelect.processCharacters(data);
	***REMOVED***;

	modes.inSelectInTable.startTagTable = function(name, attributes) ***REMOVED***
		tree.parseError("unexpected-table-element-start-tag-in-select-in-table", ***REMOVED***name: name***REMOVED***);
		this.endTagOther("select");
		tree.insertionMode.processStartTag(name, attributes);
	***REMOVED***;

	modes.inSelectInTable.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		modes.inSelect.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.inSelectInTable.endTagTable = function(name) ***REMOVED***
		tree.parseError("unexpected-table-element-end-tag-in-select-in-table", ***REMOVED***name: name***REMOVED***);
		if (tree.openElements.inTableScope(name)) ***REMOVED***
			this.endTagOther("select");
			tree.insertionMode.processEndTag(name);
		***REMOVED***
	***REMOVED***;
	...
	modes.inSelectInTable.endTagOther = function(name) ***REMOVED***
		modes.inSelect.processEndTag(name);
	***REMOVED***;

	modes.inRow = Object.create(modes.base);

	modes.inRow.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		td: 'startTagTableCell',
		th: 'startTagTableCell',
		caption: 'startTagTableOther',
	...
	***REMOVED***;
	...
	modes.inRow.end_tag_handlers = ***REMOVED***
		tr: 'endTagTr',
		table: 'endTagTable',
		tbody: 'endTagTableRowGroup',
		tfoot: 'endTagTableRowGroup',
	...
	***REMOVED***;
	...
	modes.inRow.processCharacters = function(data) ***REMOVED***
		modes.inTable.processCharacters(data);
	***REMOVED***;

	modes.inRow.startTagTableCell = function(name, attributes) ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inRow.startTagTableOther = function(name, attributes) ***REMOVED***
		var ignoreEndTag = this.ignoreEndTagTr();
		this.endTagTr('tr');
		if (!ignoreEndTag) tree.insertionMode.processStartTag(name, attributes);
	***REMOVED***;

	modes.inRow.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		modes.inTable.processStartTag(name, attributes, selfClosing);
	***REMOVED***;

	modes.inRow.endTagTr = function(name) ***REMOVED***
		if (this.ignoreEndTagTr()) ***REMOVED***
			assert.ok(tree.context);
			tree.parseError('unexpected-end-tag', ***REMOVED***name: name***REMOVED***);
		***REMOVED*** else ***REMOVED***
			tree.openElements.popUntilTableRowScopeMarker();
	...
	***REMOVED***;
	...
	modes.inRow.endTagTable = function(name) ***REMOVED***
		var ignoreEndTag = this.ignoreEndTagTr();
		this.endTagTr('tr');
		if (!ignoreEndTag) tree.insertionMode.processEndTag(name);
	***REMOVED***;

	modes.inRow.endTagTableRowGroup = function(name) ***REMOVED***
		if (tree.openElements.inTableScope(name)) ***REMOVED***
			this.endTagTr('tr');
			tree.insertionMode.processEndTag(name);
		***REMOVED*** else ***REMOVED***
	...
	***REMOVED***;
	...
	modes.inRow.endTagIgnore = function(name) ***REMOVED***
		tree.parseError("unexpected-end-tag-in-table-row", ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.inRow.endTagOther = function(name) ***REMOVED***
		modes.inTable.processEndTag(name);
	***REMOVED***;

	modes.inRow.ignoreEndTagTr = function() ***REMOVED***
		return !tree.openElements.inTableScope('tr');
	***REMOVED***;

	modes.afterAfterFrameset = Object.create(modes.base);

	modes.afterAfterFrameset.start_tag_handlers = ***REMOVED***
		html: 'startTagHtml',
		noframes: 'startTagNoFrames',
		'-default': 'startTagOther'
	***REMOVED***;

	modes.afterAfterFrameset.processEOF = function() ***REMOVED******REMOVED***;

	modes.afterAfterFrameset.processComment = function(data) ***REMOVED***
		tree.insertComment(data, tree.document);
	***REMOVED***;

	modes.afterAfterFrameset.processCharacters = function(buffer) ***REMOVED***
		var characters = buffer.takeRemaining();
		var whitespace = "";
		for (var i = 0; i < characters.length; i++) ***REMOVED***
			var ch = characters[i];
	...
	***REMOVED***;
	...
	modes.afterAfterFrameset.startTagNoFrames = function(name, attributes) ***REMOVED***
		modes.inHead.processStartTag(name, attributes);
	***REMOVED***;

	modes.afterAfterFrameset.startTagOther = function(name, attributes, selfClosing) ***REMOVED***
		tree.parseError('expected-eof-but-got-start-tag', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.afterAfterFrameset.processEndTag = function(name, attributes) ***REMOVED***
		tree.parseError('expected-eof-but-got-end-tag', ***REMOVED***name: name***REMOVED***);
	***REMOVED***;

	modes.text = Object.create(modes.base);

	modes.text.start_tag_handlers = ***REMOVED***
		'-default': 'startTagOther'
	***REMOVED***;

	modes.text.end_tag_handlers = ***REMOVED***
		script: 'endTagScript',
		'-default': 'endTagOther'
	***REMOVED***;

	modes.text.processCharacters = function(buffer) ***REMOVED***
		if (tree.shouldSkipLeadingNewline) ***REMOVED***
			tree.shouldSkipLeadingNewline = false;
			buffer.skipAtMostOneLeadingNewline();
		***REMOVED***
	...
	***REMOVED***;
	...
	modes.text.processEOF = function() ***REMOVED***
		tree.parseError("expected-named-closing-tag-but-got-eof",
			***REMOVED***name: tree.currentStackItem().localName***REMOVED***);
		tree.openElements.pop();
		tree.setInsertionMode(tree.originalInsertionMode);
		tree.insertionMode.processEOF();
	***REMOVED***;

	modes.text.startTagOther = function(name) ***REMOVED***
		throw "Tried to process start tag " + name + " in RCDATA/RAWTEXT mode";
	***REMOVED***;

	modes.text.endTagScript = function(name) ***REMOVED***
		var node = tree.openElements.pop();
		assert.ok(node.localName == 'script');
		tree.setInsertionMode(tree.originalInsertionMode);
	***REMOVED***;

	modes.text.endTagOther = function(name) ***REMOVED***
		tree.openElements.pop();
		tree.setInsertionMode(tree.originalInsertionMode);
	***REMOVED***;
***REMOVED***

TreeBuilder.prototype.setInsertionMode = function(name) ***REMOVED***
	this.insertionMode = this.insertionModes[name];
	this.insertionModeName = name;
***REMOVED***;
TreeBuilder.prototype.adoptionAgencyEndTag = function(name) ***REMOVED***
	var outerIterationLimit = 8;
	var innerIterationLimit = 3;
	var formattingElement;

	function isActiveFormattingElement(el) ***REMOVED***
		return el === formattingElement;
	***REMOVED***

	var outerLoopCounter = 0;

	while (outerLoopCounter++ < outerIterationLimit) ***REMOVED***
		formattingElement = this.elementInActiveFormattingElements(name);

		if (!formattingElement || (this.openElements.contains(formattingElement) && !this.openElements.inScope(formattingElement.localName))) ***REMOVED***
			this.parseError('adoption-agency-1.1', ***REMOVED***name: name***REMOVED***);
			return false;
		***REMOVED***
		if (!this.openElements.contains(formattingElement)) ***REMOVED***
			this.parseError('adoption-agency-1.2', ***REMOVED***name: name***REMOVED***);
			this.removeElementFromActiveFormattingElements(formattingElement);
			return true;
		***REMOVED***
		if (!this.openElements.inScope(formattingElement.localName)) ***REMOVED***
			this.parseError('adoption-agency-4.4', ***REMOVED***name: name***REMOVED***);
		***REMOVED***

		if (formattingElement != this.currentStackItem()) ***REMOVED***
			this.parseError('adoption-agency-1.3', ***REMOVED***name: name***REMOVED***);
		***REMOVED***
		var furthestBlock = this.openElements.furthestBlockForFormattingElement(formattingElement.node);

		if (!furthestBlock) ***REMOVED***
		...
		***REMOVED***
		...
		while (innerLoopCounter++ < innerIterationLimit) ***REMOVED***
			index -= 1;
			node = this.openElements.item(index);
			if (this.activeFormattingElements.indexOf(node) < 0) ***REMOVED***
		...
		***REMOVED***
		...
		this.detachFromParent(lastNode.node);
		if (commonAncestor.isFosterParenting()) ***REMOVED***
...
TreeBuilder.prototype.start = function() ***REMOVED***
	throw "Not mplemented";
***REMOVED***;

TreeBuilder.prototype.startTokenization = function(tokenizer) ***REMOVED***
...
TreeBuilder.prototype.processToken = function(token) ***REMOVED***
	this.selfClosingFlagAcknowledged = false;
	...
	if (!currentNode || !currentNode.isForeign() ||
		(currentNode.isMathMLTextIntegrationPoint() &&
			((token.type == 'StartTag' &&
					!(token.name in ***REMOVED***mglyph:0, malignmark:0***REMOVED***)) ||
		...
		(currentNode.isHtmlIntegrationPoint() &&
			token.type in ***REMOVED***StartTag:0, Characters:0***REMOVED***
		) ||
		token.type == 'EOF'
	) ***REMOVED***
	...
	***REMOVED***
***REMOVED***;
TreeBuilder.prototype.isCdataSectionAllowed = function() ***REMOVED***
	return this.openElements.length > 0 && this.currentStackItem().isForeign();
***REMOVED***;
TreeBuilder.prototype.isSelfClosingFlagAcknowledged = function() ***REMOVED***
	return this.selfClosingFlagAcknowledged;
***REMOVED***;

TreeBuilder.prototype.createElement = function(namespaceURI, localName, attributes) ***REMOVED***
	throw new Error("Not implemented");
***REMOVED***;

TreeBuilder.prototype.attachNode = function(child, parent) ***REMOVED***
	throw new Error("Not implemented");
***REMOVED***;

TreeBuilder.prototype.attachNodeToFosterParent = function(child, table, stackParent) ***REMOVED***
	throw new Error("Not implemented");
***REMOVED***;

TreeBuilder.prototype.detachFromParent = function(node) ***REMOVED***
	throw new Error("Not implemented");
***REMOVED***;

TreeBuilder.prototype.addAttributesToElement = function(element, attributes) ***REMOVED***
	throw new Error("Not implemented");
***REMOVED***;

TreeBuilder.prototype.insertHtmlElement = function(attributes) ***REMOVED***
...
TreeBuilder.prototype.insertHeadElement = function(attributes) ***REMOVED***
...
TreeBuilder.prototype.insertBodyElement = function(attributes) ***REMOVED***
...
TreeBuilder.prototype.insertIntoFosterParent = function(node) ***REMOVED***
...
TreeBuilder.prototype.insertElement = function(name, attributes, namespaceURI, selfClosing) ***REMOVED***
	if (!namespaceURI)
...
TreeBuilder.prototype.insertFormattingElement = function(name, attributes) ***REMOVED***
...
TreeBuilder.prototype.insertSelfClosingElement = function(name, attributes) ***REMOVED***
	this.selfClosingFlagAcknowledged = true;
	this.insertElement(name, attributes, "http://www.w3.org/1999/xhtml", true);
***REMOVED***;

TreeBuilder.prototype.insertForeignElement = function(name, attributes, namespaceURI, selfClosing) ***REMOVED***
	if (selfClosing)
		this.selfClosingFlagAcknowledged = true;
	this.insertElement(name, attributes, namespaceURI, selfClosing);
***REMOVED***;

TreeBuilder.prototype.insertComment = function(data, parent) ***REMOVED***
	throw new Error("Not implemented");
***REMOVED***;

TreeBuilder.prototype.insertDoctype = function(name, publicId, systemId) ***REMOVED***
	throw new Error("Not implemented");
***REMOVED***;

TreeBuilder.prototype.insertText = function(data) ***REMOVED***
	throw new Error("Not implemented");
***REMOVED***;
TreeBuilder.prototype.currentStackItem = function() ***REMOVED***
	return this.openElements.top;
***REMOVED***;
TreeBuilder.prototype.popElement = function() ***REMOVED***
	return this.openElements.pop();
***REMOVED***;
TreeBuilder.prototype.shouldFosterParent = function() ***REMOVED***
	return this.redirectAttachToFosterParent && this.currentStackItem().isFosterParenting();
***REMOVED***;
TreeBuilder.prototype.generateImpliedEndTags = function(exclude) ***REMOVED***
	var name = this.openElements.top.localName;
	if (['dd', 'dt', 'li', 'option', 'optgroup', 'p', 'rp', 'rt'].indexOf(name) != -1 && name != exclude) ***REMOVED***
		this.popElement();
		this.generateImpliedEndTags(exclude);
	***REMOVED***
***REMOVED***;
TreeBuilder.prototype.reconstructActiveFormattingElements = function() ***REMOVED***
	...
	while (entry != Marker && !this.openElements.contains(entry)) ***REMOVED***
		i -= 1;
...
***REMOVED***;
TreeBuilder.prototype.ensureNoahsArkCondition = function(item) ***REMOVED***
	...
	for (var i = this.activeFormattingElements.length - 1; i >= 0; i--) ***REMOVED***
	...
	***REMOVED***
	...
	for (var i = 0; i < attributes.length; i++) ***REMOVED***
		var attribute = attributes[i];

		for (var j = 0; j < candidates.length; j++) ***REMOVED***
...
***REMOVED***;
TreeBuilder.prototype.appendElementToActiveFormattingElements = function(item) ***REMOVED***
	this.ensureNoahsArkCondition(item);
	this.activeFormattingElements.push(item);
***REMOVED***;
TreeBuilder.prototype.removeElementFromActiveFormattingElements = function(item) ***REMOVED***
	var index = this.activeFormattingElements.indexOf(item);
	if (index >= 0)
		this.activeFormattingElements.splice(index, 1);
***REMOVED***;

TreeBuilder.prototype.elementInActiveFormattingElements = function(name) ***REMOVED***
...
TreeBuilder.prototype.clearActiveFormattingElements = function() ***REMOVED***
    while (!(this.activeFormattingElements.length === 0 || this.activeFormattingElements.pop() == Marker));
***REMOVED***;

TreeBuilder.prototype.reparentChildren = function(oldParent, newParent) ***REMOVED***
	throw new Error("Not implemented");
***REMOVED***;
TreeBuilder.prototype.setFragmentContext = function(context) ***REMOVED***
	this.context = context;
***REMOVED***;
TreeBuilder.prototype.parseError = function(code, args) ***REMOVED***
...
***REMOVED***;
TreeBuilder.prototype.resetInsertionMode = function() ***REMOVED***
	var last = false;
	var node = null;
	for (var i = this.openElements.length - 1; i >= 0; i--) ***REMOVED***
...
TreeBuilder.prototype.processGenericRCDATAStartTag = function(name, attributes) ***REMOVED***
...
TreeBuilder.prototype.processGenericRawTextStartTag = function(name, attributes) ***REMOVED***
	this.insertElement(name, attributes);
	this.tokenizer.setState(Tokenizer.RAWTEXT);
	this.originalInsertionMode = this.insertionModeName;
	this.setInsertionMode('text');
...
TreeBuilder.prototype.adjustMathMLAttributes = function(attributes) ***REMOVED***
	attributes.forEach(function(a) ***REMOVED***
...
TreeBuilder.prototype.adjustSVGTagNameCase = function(name) ***REMOVED***
	return constants.SVGTagMap[name] || name;
***REMOVED***;

TreeBuilder.prototype.adjustSVGAttributes = function(attributes) ***REMOVED***
	attributes.forEach(function(a) ***REMOVED***
...
TreeBuilder.prototype.adjustForeignAttributes = function(attributes) ***REMOVED***
	for (var i = 0; i < attributes.length; i++) ***REMOVED***
		var attribute = attributes[i];
...
function formatMessage(format, args) ***REMOVED***
	return format.replace(new RegExp('***REMOVED***[0-9a-z-]+***REMOVED***', 'gi'), function(match) ***REMOVED***
...
***REMOVED***,
***REMOVED***"./ElementStack":1,"./StackItem":4,"./Tokenizer":5,"./constants":7,"./messages.json":8,"assert":13,"events":16***REMOVED***],
7:[function(_dereq_,module,exports)***REMOVED***
exports.SVGTagMap = ***REMOVED***
	"altglyph": "altGlyph",
...
exports.MATHMLAttributeMap = ***REMOVED***
	definitionurl: 'definitionURL'
***REMOVED***;

exports.SVGAttributeMap = ***REMOVED***
...
exports.ForeignAttributeMap = ***REMOVED***
	"xlink:actuate": ***REMOVED***prefix: "xlink", localName: "actuate", namespaceURI: "http://www.w3.org/1999/xlink"***REMOVED***,
	"xlink:arcrole": ***REMOVED***prefix: "xlink", localName: "arcrole", namespaceURI: "http://www.w3.org/1999/xlink"***REMOVED***,
	"xlink:href": ***REMOVED***prefix: "xlink", localName: "href", namespaceURI: "http://www.w3.org/1999/xlink"***REMOVED***,
	"xlink:role": ***REMOVED***prefix: "xlink", localName: "role", namespaceURI: "http://www.w3.org/1999/xlink"***REMOVED***,
	"xlink:show": ***REMOVED***prefix: "xlink", localName: "show", namespaceURI: "http://www.w3.org/1999/xlink"***REMOVED***,
	"xlink:title": ***REMOVED***prefix: "xlink", localName: "title", namespaceURI: "http://www.w3.org/1999/xlink"***REMOVED***,
	"xlink:type": ***REMOVED***prefix: "xlink", localName: "title", namespaceURI: "http://www.w3.org/1999/xlink"***REMOVED***,
	"xml:base": ***REMOVED***prefix: "xml", localName: "base", namespaceURI: "http://www.w3.org/XML/1998/namespace"***REMOVED***,
	"xml:lang": ***REMOVED***prefix: "xml", localName: "lang", namespaceURI: "http://www.w3.org/XML/1998/namespace"***REMOVED***,
	"xml:space": ***REMOVED***prefix: "xml", localName: "space", namespaceURI: "http://www.w3.org/XML/1998/namespace"***REMOVED***,
	"xmlns": ***REMOVED***prefix: null, localName: "xmlns", namespaceURI: "http://www.w3.org/2000/xmlns/"***REMOVED***,
	"xmlns:xlink": ***REMOVED***prefix: "xmlns", localName: "xlink", namespaceURI: "http://www.w3.org/2000/xmlns/"***REMOVED***,
***REMOVED***;
***REMOVED***,
***REMOVED******REMOVED***],
...
module.exports=***REMOVED***
	...
	"cant-convert-numeric-entity":
		"Numeric entity couldn't be converted to character (codepoint U+***REMOVED***charAsInt***REMOVED***).",
	...
	"expected-closing-tag-but-got-char":
		"Expected closing tag. Unexpected character '***REMOVED***data***REMOVED***' found.",
	"eof-in-tag-name":
	...
	"invalid-character-in-attribute-name":
		"Invalid character in attribute name.",
	"duplicate-attribute":
		"Dropped duplicate attribute '***REMOVED***name***REMOVED***' on tag.",
	...
	"expected-space-or-right-bracket-in-doctype":
		"Expected space or '>'. Got '***REMOVED***data***REMOVED***'.",
	...
	"end-tag-after-implied-root":
		"Unexpected end tag (***REMOVED***name***REMOVED***) after the (implied) root element.",
	"expected-named-closing-tag-but-got-eof":
		"Unexpected end of file. Expected end tag (***REMOVED***name***REMOVED***).",
	"two-heads-are-not-better-than-one":
		"Unexpected start tag head in existing head. Ignored.",
	"unexpected-end-tag":
		"Unexpected end tag (***REMOVED***name***REMOVED***). Ignored.",
	"unexpected-implied-end-tag":
		"End tag ***REMOVED***name***REMOVED*** implied, but there were open elements.",
	"unexpected-start-tag-out-of-my-head":
		"Unexpected start tag (***REMOVED***name***REMOVED***) that can be in head. Moved.",
	"unexpected-start-tag":
		"Unexpected start tag (***REMOVED***name***REMOVED***).",
	"missing-end-tag":
		"Missing end tag (***REMOVED***name***REMOVED***).",
	"missing-end-tags":
		"Missing end tags (***REMOVED***name***REMOVED***).",
	"unexpected-start-tag-implies-end-tag":
		"Unexpected start tag (***REMOVED***startName***REMOVED***) implies end tag (***REMOVED***endName***REMOVED***).",
	"unexpected-start-tag-treated-as":
		"Unexpected start tag (***REMOVED***originalName***REMOVED***). Treated as ***REMOVED***newName***REMOVED***.",
	"deprecated-tag":
		"Unexpected start tag ***REMOVED***name***REMOVED***. Don't use it!",
	"unexpected-start-tag-ignored":
		"Unexpected start tag ***REMOVED***name***REMOVED***. Ignored.",
	"expected-one-end-tag-but-got-another":
		"Unexpected end tag (***REMOVED***gotName***REMOVED***). Missing end tag (***REMOVED***expectedName***REMOVED***).",
	"end-tag-too-early":
		"End tag (***REMOVED***name***REMOVED***) seen too early. Expected other end tag.",
	"end-tag-too-early-named":
		"Unexpected end tag (***REMOVED***gotName***REMOVED***). Expected end tag (***REMOVED***expectedName***REMOVED***.",
	"end-tag-too-early-ignored":
		"End tag (***REMOVED***name***REMOVED***) seen too early. Ignored.",
	"adoption-agency-1.1":
		"End tag (***REMOVED***name***REMOVED***) violates step 1, paragraph 1 of the adoption agency algorithm.",
	"adoption-agency-1.2":
		"End tag (***REMOVED***name***REMOVED***) violates step 1, paragraph 2 of the adoption agency algorithm.",
	"adoption-agency-1.3":
		"End tag (***REMOVED***name***REMOVED***) violates step 1, paragraph 3 of the adoption agency algorithm.",
	"adoption-agency-4.4":
		"End tag (***REMOVED***name***REMOVED***) violates step 4, paragraph 4 of the adoption agency algorithm.",
	"unexpected-end-tag-treated-as":
		"Unexpected end tag (***REMOVED***originalName***REMOVED***). Treated as ***REMOVED***newName***REMOVED***.",
	"no-end-tag":
		"This element (***REMOVED***name***REMOVED***) has no end tag.",
	"unexpected-implied-end-tag-in-table":
		"Unexpected implied end tag (***REMOVED***name***REMOVED***) in the table phase.",
	"unexpected-implied-end-tag-in-table-body":
		"Unexpected implied end tag (***REMOVED***name***REMOVED***) in the table body phase.",
	...
	"unexpected-start-tag-implies-table-voodoo":
		"Unexpected start tag (***REMOVED***name***REMOVED***) in table context caused voodoo mode.",
	"unexpected-end-tag-implies-table-voodoo":
		"Unexpected end tag (***REMOVED***name***REMOVED***) in table context caused voodoo mode.",
	"unexpected-cell-in-table-body":
		"Unexpected table cell start tag (***REMOVED***name***REMOVED***) in the table body phase.",
	"unexpected-cell-end-tag":
		"Got table cell end tag (***REMOVED***name***REMOVED***) while required end tags are missing.",
	"unexpected-end-tag-in-table-body":
		"Unexpected end tag (***REMOVED***name***REMOVED***) in the table body phase. Ignored.",
	"unexpected-implied-end-tag-in-table-row":
		"Unexpected implied end tag (***REMOVED***name***REMOVED***) in the table row phase.",
	"unexpected-end-tag-in-table-row":
		"Unexpected end tag (***REMOVED***name***REMOVED***) in the table row phase. Ignored.",
	"unexpected-select-in-select":
		"Unexpected select start tag in the select phase treated as select end tag.",
	"unexpected-input-in-select":
		"Unexpected input start tag in the select phase.",
	"unexpected-start-tag-in-select":
		"Unexpected start tag token (***REMOVED***name***REMOVED***) in the select phase. Ignored.",
	"unexpected-end-tag-in-select":
		"Unexpected end tag (***REMOVED***name***REMOVED***) in the select phase. Ignored.",
	"unexpected-table-element-start-tag-in-select-in-table":
		"Unexpected table element start tag (***REMOVED***name***REMOVED***) in the select in table phase.",
	"unexpected-table-element-end-tag-in-select-in-table":
		"Unexpected table element end tag (***REMOVED***name***REMOVED***) in the select in table phase.",
	"unexpected-char-after-body":
		"Unexpected non-space characters in the after body phase.",
	"unexpected-start-tag-after-body":
		"Unexpected start tag token (***REMOVED***name***REMOVED***) in the after body phase.",
	"unexpected-end-tag-after-body":
		"Unexpected end tag token (***REMOVED***name***REMOVED***) in the after body phase.",
	"unexpected-char-in-frameset":
		"Unepxected characters in the frameset phase. Characters ignored.",
	"unexpected-start-tag-in-frameset":
		"Unexpected start tag token (***REMOVED***name***REMOVED***) in the frameset phase. Ignored.",
	"unexpected-frameset-in-frameset-innerhtml":
		"Unexpected end tag token (frameset in the frameset phase (innerHTML).",
	"unexpected-end-tag-in-frameset":
		"Unexpected end tag token (***REMOVED***name***REMOVED***) in the frameset phase. Ignored.",
	"unexpected-char-after-frameset":
		"Unexpected non-space characters in the after frameset phase. Ignored.",
	"unexpected-start-tag-after-frameset":
		"Unexpected start tag (***REMOVED***name***REMOVED***) in the after frameset phase. Ignored.",
	"unexpected-end-tag-after-frameset":
		"Unexpected end tag (***REMOVED***name***REMOVED***) in the after frameset phase. Ignored.",
	"expected-eof-but-got-char":
		"Unexpected non-space characters. Expected end of file.",
	"expected-eof-but-got-start-tag":
		"Unexpected start tag (***REMOVED***name***REMOVED***). Expected end of file.",
	"expected-eof-but-got-end-tag":
		"Unexpected end tag (***REMOVED***name***REMOVED***). Expected end of file.",
	...
	"non-void-element-with-trailing-solidus":
		"Trailing solidus not allowed on element ***REMOVED***name***REMOVED***.",
	"unexpected-html-element-in-foreign-content":
		"HTML start tag \"***REMOVED***name***REMOVED***\" in a foreign namespace context.",
	"unexpected-start-tag-in-table":
		"Unexpected ***REMOVED***name***REMOVED***. Expected table content."
***REMOVED***
***REMOVED***,
***REMOVED******REMOVED***],
...
SAXParser.prototype.parse = function(source) ***REMOVED***
...
SAXParser.prototype.parseFragment = function(source, context) ***REMOVED***
...
Object.defineProperty(SAXParser.prototype, 'scriptingEnabled', ***REMOVED***
	get: function() ***REMOVED***
...
Object.defineProperty(SAXParser.prototype, 'errorHandler', ***REMOVED***
	get: function() ***REMOVED***
...
***REMOVED***,
***REMOVED***"../Tokenizer":5,"./SAXTreeBuilder":10,"./TreeParser":11***REMOVED***],
10:[function(_dereq_,module,exports)***REMOVED***
var util = _dereq_('util');
var TreeBuilder = _dereq_('../TreeBuilder').TreeBuilder;

function SAXTreeBuilder() ***REMOVED***
	TreeBuilder.call(this);
***REMOVED***

util.inherits(SAXTreeBuilder, TreeBuilder);

SAXTreeBuilder.prototype.start = function(tokenizer) ***REMOVED***
	this.document = new Document(this.tokenizer);
***REMOVED***;

SAXTreeBuilder.prototype.end = function() ***REMOVED***
	this.document.endLocator = this.tokenizer;
***REMOVED***;

SAXTreeBuilder.prototype.insertDoctype = function(name, publicId, systemId) ***REMOVED***
	var doctype = new DTD(this.tokenizer, name, publicId, systemId);
	doctype.endLocator = this.tokenizer;
	this.document.appendChild(doctype);
***REMOVED***;

SAXTreeBuilder.prototype.createElement = function(namespaceURI, localName, attributes) ***REMOVED***
	var element = new Element(this.tokenizer, namespaceURI, localName, localName, attributes || []);
	return element;
***REMOVED***;

SAXTreeBuilder.prototype.insertComment = function(data, parent) ***REMOVED***
	if (!parent)
...
SAXTreeBuilder.prototype.appendCharacters = function(parent, data) ***REMOVED***
	var text = new Characters(this.tokenizer, data);
	parent.appendChild(text);
***REMOVED***;

SAXTreeBuilder.prototype.insertText = function(data) ***REMOVED***
	if (this.redirectAttachToFosterParent && this.openElements.top.isFosterParenting()) ***REMOVED***
		var tableIndex = this.openElements.findIndex('table');
		var tableItem = this.openElements.item(tableIndex);
		var table = tableItem.node;
		if (tableIndex === 0) ***REMOVED***
...
SAXTreeBuilder.prototype.attachNode = function(node, parent) ***REMOVED***
	parent.appendChild(node);
***REMOVED***;

SAXTreeBuilder.prototype.attachNodeToFosterParent = function(child, table, stackParent) ***REMOVED***
	var parent = table.parentNode;
	if (parent)
...
SAXTreeBuilder.prototype.detachFromParent = function(element) ***REMOVED***
	element.detach();
***REMOVED***;

SAXTreeBuilder.prototype.reparentChildren = function(oldParent, newParent) ***REMOVED***
	newParent.appendChildren(oldParent.firstChild);
***REMOVED***;

SAXTreeBuilder.prototype.getFragment = function() ***REMOVED***
...
SAXTreeBuilder.prototype.addAttributesToElement = function(element, attributes) ***REMOVED***
	for (var i = 0; i < attributes.length; i++) ***REMOVED***
		var attribute = attributes[i];
...
***REMOVED***
Node.prototype.visit = function(treeParser) ***REMOVED***
	throw new Error("Not Implemented");
***REMOVED***;
Node.prototype.revisit = function(treeParser) ***REMOVED***
	return;
***REMOVED***;
Node.prototype.detach = function() ***REMOVED***
	if (this.parentNode !== null) ***REMOVED***
		this.parentNode.removeChild(this);
		this.parentNode = null;
	***REMOVED***
***REMOVED***;

Object.defineProperty(Node.prototype, 'previousSibling', ***REMOVED***
	get: function() ***REMOVED***
		var prev = null;
...
function ParentNode(locator) ***REMOVED***
...
ParentNode.prototype.insertBefore = function(child, sibling) ***REMOVED***
	if (!sibling) ***REMOVED***
		return this.appendChild(child);
	***REMOVED***
	child.detach();
	child.parentNode = this;
	if (this.firstChild == sibling) ***REMOVED***
		child.nextSibling = sibling;
		this.firstChild = child;
	***REMOVED*** else ***REMOVED***
		var prev = this.firstChild;
		var next = this.firstChild.nextSibling;
		while (next != sibling) ***REMOVED***
			prev = next;
			next = next.nextSibling;
		***REMOVED***
...
ParentNode.prototype.insertBetween = function(child, prev, next) ***REMOVED***
	if (!next) ***REMOVED***
		return this.appendChild(child);
	***REMOVED***
	child.detach();
	...
	***REMOVED***
	return child;
***REMOVED***;
ParentNode.prototype.appendChild = function(child) ***REMOVED***
	child.detach();
	child.parentNode = this;
	if (!this.firstChild) ***REMOVED***
		this.firstChild = child;
	***REMOVED*** else ***REMOVED***
	...
	***REMOVED***
	...
	return child;
***REMOVED***;
ParentNode.prototype.appendChildren = function(parent) ***REMOVED***
	...
	***REMOVED***
	...
	do ***REMOVED***
		child.parentNode = this;
	***REMOVED*** while ((child = child.nextSibling));
	another.firstChild = null;
	another.lastChild = null;
***REMOVED***;
ParentNode.prototype.removeChild = function(node) ***REMOVED***
	if (this.firstChild == node) ***REMOVED***
		this.firstChild = node.nextSibling;
		if (this.lastChild == node) ***REMOVED***
			this.lastChild = null;
		***REMOVED***
	***REMOVED*** else ***REMOVED***
		var prev = this.firstChild;
		var next = this.firstChild.nextSibling;
		while (next != node) ***REMOVED***
			prev = next;
			next = next.nextSibling;
		***REMOVED***
...
Object.defineProperty(ParentNode.prototype, 'endLocator', ***REMOVED***
	get: function() ***REMOVED***
		return this._endLocator;
	***REMOVED***,
	set: function(endLocator) ***REMOVED***
		this._endLocator = ***REMOVED***
			lineNumber: endLocator.lineNumber,
			columnNumber: endLocator.columnNumber
		***REMOVED***;
	***REMOVED***
***REMOVED***);
function Document (locator) ***REMOVED***
	ParentNode.call(this, locator);
	this.nodeType = NodeType.DOCUMENT;
***REMOVED***

Document.prototype = Object.create(ParentNode.prototype);
Document.prototype.visit = function(treeParser) ***REMOVED***
	treeParser.startDocument(this);
***REMOVED***;
Document.prototype.revisit = function(treeParser) ***REMOVED***
	treeParser.endDocument(this.endLocator);
***REMOVED***;
function DocumentFragment() ***REMOVED***
...
DocumentFragment.prototype.visit = function(treeParser) ***REMOVED***
***REMOVED***;
function Element(locator, uri, localName, qName, atts, prefixMappings) ***REMOVED***
	ParentNode.call(this, locator);
	this.uri = uri;
	this.localName = localName;
	this.qName = qName;
...
Element.prototype.visit = function(treeParser) ***REMOVED***
	if (this.prefixMappings) ***REMOVED***
		for (var key in prefixMappings) ***REMOVED***
...
***REMOVED***;
Element.prototype.revisit = function(treeParser) ***REMOVED***
	...
	***REMOVED***
***REMOVED***;
function Characters(locator, data)***REMOVED***
	Node.call(this, locator);
	this.data = data;
...
Characters.prototype.visit = function (treeParser) ***REMOVED***
	treeParser.characters(this.data, 0, this.data.length, this);
***REMOVED***;
function IgnorableWhitespace(locator, data) ***REMOVED***
	Node.call(this, locator);
	this.data = data;
...
IgnorableWhitespace.prototype.visit = function(treeParser) ***REMOVED***
	treeParser.ignorableWhitespace(this.data, 0, this.data.length, this);
***REMOVED***;
function Comment(locator, data) ***REMOVED***
	Node.call(this, locator);
	this.data = data;
...
Comment.prototype.visit = function(treeParser) ***REMOVED***
	treeParser.comment(this.data, 0, this.data.length, this);
***REMOVED***;
function CDATA(locator) ***REMOVED***
	ParentNode.call(this, locator);
	this.nodeType = NodeType.CDATA;
***REMOVED***

CDATA.prototype = Object.create(ParentNode.prototype);
CDATA.prototype.visit = function(treeParser) ***REMOVED***
	treeParser.startCDATA(this);
***REMOVED***;
CDATA.prototype.revisit = function(treeParser) ***REMOVED***
	treeParser.endCDATA(this.endLocator);
***REMOVED***;
function Entity(name) ***REMOVED***
...
Entity.prototype.visit = function(treeParser) ***REMOVED***
	treeParser.startEntity(this.name, this);
***REMOVED***;
Entity.prototype.revisit = function(treeParser) ***REMOVED***
	treeParser.endEntity(this.name);
***REMOVED***;

function SkippedEntity(name) ***REMOVED***
	Node.call(this);
	this.name = name;
...
SkippedEntity.prototype.visit = function(treeParser) ***REMOVED***
	treeParser.skippedEntity(this.name, this);
***REMOVED***;
function ProcessingInstruction(target, data) ***REMOVED***
	Node.call(this);
	this.target = target;
	this.data = data;
***REMOVED***
...
ProcessingInstruction.prototype.visit = function(treeParser) ***REMOVED***
	treeParser.processingInstruction(this.target, this.data, this);
***REMOVED***;
ProcessingInstruction.prototype.getNodeType = function() ***REMOVED***
	return NodeType.PROCESSING_INSTRUCTION;
***REMOVED***;
function DTD(name, publicIdentifier, systemIdentifier) ***REMOVED***
	ParentNode.call(this);
	this.name = name;
...
DTD.prototype.visit = function(treeParser) ***REMOVED***
	treeParser.startDTD(this.name, this.publicIdentifier, this.systemIdentifier, this);
***REMOVED***;
DTD.prototype.revisit = function(treeParser) ***REMOVED***
	treeParser.endDTD();
***REMOVED***;
...
***REMOVED***,
***REMOVED***"../TreeBuilder":6,"util":20***REMOVED***],
11:[function(_dereq_,module,exports)***REMOVED***
function TreeParser(contentHandler, lexicalHandler)***REMOVED***
	this.contentHandler;
	this.lexicalHandler;
	this.locatorDelegate;

	if (!contentHandler) ***REMOVED***
		throw new IllegalArgumentException("contentHandler was null.");
	***REMOVED***
	this.contentHandler = contentHandler;
	if (!lexicalHandler) ***REMOVED***
		this.lexicalHandler = new NullLexicalHandler();
	***REMOVED*** else ***REMOVED***
		this.lexicalHandler = lexicalHandler;
	***REMOVED***
***REMOVED***
TreeParser.prototype.parse = function(node) ***REMOVED***
	this.contentHandler.documentLocator = this;
	var current = node;
	var next;
	for (;;) ***REMOVED***
		current.visit(this);
		if (next = current.firstChild) ***REMOVED***
			current = next;
			continue;
		***REMOVED***
		for (;;) ***REMOVED***
			current.revisit(this);
			if (current == node) ***REMOVED***
				return;
			***REMOVED***
			if (next = current.nextSibling) ***REMOVED***
				current = next;
				break;
			***REMOVED***
	...
	***REMOVED***
***REMOVED***;
TreeParser.prototype.characters = function(ch, start, length, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.characters(ch, start, length);
***REMOVED***;
TreeParser.prototype.endDocument = function(locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.endDocument();
***REMOVED***;
TreeParser.prototype.endElement = function(uri, localName, qName, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.endElement(uri, localName, qName);
***REMOVED***;
TreeParser.prototype.endPrefixMapping = function(prefix, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.endPrefixMapping(prefix);
***REMOVED***;
TreeParser.prototype.ignorableWhitespace = function(ch, start, length, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.ignorableWhitespace(ch, start, length);
***REMOVED***;
TreeParser.prototype.processingInstruction = function(target, data, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.processingInstruction(target, data);
***REMOVED***;
TreeParser.prototype.skippedEntity = function(name, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.skippedEntity(name);
***REMOVED***;
TreeParser.prototype.startDocument = function(locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.startDocument();
***REMOVED***;
TreeParser.prototype.startElement = function(uri, localName, qName, atts, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.startElement(uri, localName, qName, atts);
***REMOVED***;
TreeParser.prototype.startPrefixMapping = function(prefix, uri, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.contentHandler.startPrefixMapping(prefix, uri);
***REMOVED***;
TreeParser.prototype.comment = function(ch, start, length, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.lexicalHandler.comment(ch, start, length);
***REMOVED***;
TreeParser.prototype.endCDATA = function(locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.lexicalHandler.endCDATA();
***REMOVED***;
TreeParser.prototype.endDTD = function(locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.lexicalHandler.endDTD();
***REMOVED***;
TreeParser.prototype.endEntity = function(name, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.lexicalHandler.endEntity(name);
***REMOVED***;
TreeParser.prototype.startCDATA = function(locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.lexicalHandler.startCDATA();
***REMOVED***;
TreeParser.prototype.startDTD = function(name, publicId, systemId, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.lexicalHandler.startDTD(name, publicId, systemId);
***REMOVED***;
TreeParser.prototype.startEntity = function(name, locator) ***REMOVED***
	this.locatorDelegate = locator;
	this.lexicalHandler.startEntity(name);
***REMOVED***;

Object.defineProperty(TreeParser.prototype, 'columnNumber', ***REMOVED***
	get: function() ***REMOVED***
...
Object.defineProperty(TreeParser.prototype, 'lineNumber', ***REMOVED***
	get: function() ***REMOVED***
		if (!this.locatorDelegate)
			return -1;
		else
	...
	***REMOVED***
***REMOVED***);
function NullLexicalHandler() ***REMOVED***

***REMOVED***

NullLexicalHandler.prototype.comment = function() ***REMOVED******REMOVED***;
NullLexicalHandler.prototype.endCDATA = function() ***REMOVED******REMOVED***;
NullLexicalHandler.prototype.endDTD = function() ***REMOVED******REMOVED***;
NullLexicalHandler.prototype.endEntity = function() ***REMOVED******REMOVED***;
NullLexicalHandler.prototype.startCDATA = function() ***REMOVED******REMOVED***;
NullLexicalHandler.prototype.startDTD = function() ***REMOVED******REMOVED***;
NullLexicalHandler.prototype.startEntity = function() ***REMOVED******REMOVED***;

exports.TreeParser = TreeParser;

***REMOVED***,
***REMOVED******REMOVED***],
12:[function(_dereq_,module,exports)***REMOVED***
module.exports = ***REMOVED***
	"Aacute;": "\u00C1",
	"Aacute": "\u00C1",
	"aacute;": "\u00E1",
...
***REMOVED***,
***REMOVED******REMOVED***],
13:[function(_dereq_,module,exports)***REMOVED***
var util = _dereq_('util/');
...
function replacer(key, value) ***REMOVED***
  if (util.isUndefined(value)) ***REMOVED***
    return '' + value;
  ***REMOVED***
  if (util.isNumber(value) && (isNaN(value) || !isFinite(value))) ***REMOVED***
    return value.toString();
  ***REMOVED***
  if (util.isFunction(value) || util.isRegExp(value)) ***REMOVED***
    return value.toString();
  ***REMOVED***
  return value;
***REMOVED***
...
assert.deepEqual = function deepEqual(actual, expected, message) ***REMOVED***
  if (!_deepEqual(actual, expected)) ***REMOVED***
...
function _deepEqual(actual, expected) ***REMOVED***
  ...
  ***REMOVED*** else if (util.isBuffer(actual) && util.isBuffer(expected)) ***REMOVED***
...
***REMOVED***
    ...
    return true;
  ***REMOVED*** else if (util.isDate(actual) && util.isDate(expected)) ***REMOVED***
    return actual.getTime() === expected.getTime();
  ***REMOVED*** else if (util.isRegExp(actual) && util.isRegExp(expected)) ***REMOVED***
    return actual.source === expected.source &&
           actual.global === expected.global &&
           actual.multiline === expected.multiline &&
           actual.lastIndex === expected.lastIndex &&
           actual.ignoreCase === expected.ignoreCase;
  ***REMOVED*** else if (!util.isObject(actual) && !util.isObject(expected)) ***REMOVED***
...
function expectedException(actual, expected) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (Object.prototype.toString.call(expected) == '[object RegExp]') ***REMOVED***
    return expected.test(actual);
  ***REMOVED*** else if (actual instanceof expected) ***REMOVED***
    return true;
  ***REMOVED*** else if (expected.call(***REMOVED******REMOVED***, actual) === true) ***REMOVED***
    return true;
  ***REMOVED***
...
function _throws(shouldThrow, block, expected, message) ***REMOVED***
  ...
  if (util.isString(expected)) ***REMOVED***
    message = expected;
    expected = null;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (!shouldThrow && expectedException(actual, expected)) ***REMOVED***
    fail(actual, expected, 'Got unwanted exception' + message);
  ***REMOVED***

  if ((shouldThrow && actual && expected &&
      !expectedException(actual, expected)) || (!shouldThrow && actual)) ***REMOVED***
    throw actual;
  ***REMOVED***
***REMOVED***
...
assert.ifError = function(err) ***REMOVED*** if (err) ***REMOVED***throw err;***REMOVED******REMOVED***;
...
***REMOVED***,
***REMOVED***"util/":15***REMOVED***],
14:[function(_dereq_,module,exports)***REMOVED***
...
***REMOVED***,
***REMOVED******REMOVED***],
15:[function(_dereq_,module,exports)***REMOVED***
(function (process,global)***REMOVED***
...
***REMOVED***).call(this,_dereq_("/usr/local/lib/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : ***REMOVED******REMOVED***)
***REMOVED***,
***REMOVED***"./support/isBuffer":14,"/usr/local/lib/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":18,"inherits":17***REMOVED***],
16:[function(_dereq_,module,exports)***REMOVED***
...
***REMOVED***,
***REMOVED******REMOVED***],
17:[function(_dereq_,module,exports)***REMOVED***
...
***REMOVED***,
***REMOVED******REMOVED***],
18:[function(_dereq_,module,exports)***REMOVED***
...
process.nextTick = (function () ***REMOVED***
    ...
    if (canSetImmediate) ***REMOVED***
        return function (f) ***REMOVED*** return window.setImmediate(f) ***REMOVED***;
***REMOVED***
    ...
    if (canPost) ***REMOVED***
        ...
        window.addEventListener('message', function (ev) ***REMOVED***
            ...
            if ((source === window || source === null) && ev.data === 'process-tick') ***REMOVED***
                ev.stopPropagation();
    ...
    ***REMOVED*** true);
        ...
        return function nextTick(fn) ***REMOVED***
            queue.push(fn);
...
***REMOVED***,
***REMOVED******REMOVED***],
19:[function(_dereq_,module,exports)***REMOVED***
module.exports=_dereq_(14)
***REMOVED***,
***REMOVED******REMOVED***],
20:[function(_dereq_,module,exports)***REMOVED***
module.exports=_dereq_(15)
***REMOVED***,
***REMOVED***"./support/isBuffer":19,"/usr/local/lib/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":18,"inherits":17***REMOVED***]***REMOVED***,***REMOVED******REMOVED***,[9])
(9)
